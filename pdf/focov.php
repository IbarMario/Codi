...
class MYPDF extends TCPDF {
    ...
    public function Header() {
		...
		/////$this->Image($image_file, 70, 5, 70, 25, 'PNG');
    ...
    <tbody>';
        ...
        while ($v = $stmtp->fetch(PDO::FETCH_OBJ)) {
            if($n%2==1)
                ...
                $color="#FFFFFF";
            if ($v->cancelar == 'Hospedaje y alimentacion' || $v->cancelar == 'Hospedaje o alimentacion') {
            ...
            <tr style="text-align:center;" bgcolor="'.$color.'">
                ...
                <td width="70">'.$v->total_pasaje.'  Bs. </td>
...
$total_pasaje_us = '<br /><b>TOTAL PASAJES DOLARES:</b> ' .number_format(($tp / $tipo_cambio),2). ' $us.';
$contenido.='
<table border="1" cellpadding="'.$padding.'" width="100%">
    <tr><td><b>LIQUIDO PAGABLE:</b> ' .number_format($lp_bs,2). ' Bs. '.$cont_dolar.'</td><td><b>TOTAL PASAJES:</b> ' .number_format($tp,2). ' Bs.'.$total_pasaje_us.'</td></tr>
</table>
';
