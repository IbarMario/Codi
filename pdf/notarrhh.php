...
try {
    ...
    while ($rs = $stmt->fetch(PDO::FETCH_OBJ)) {
        ...
        //Hoja de ruta Freddy Velasco
    
    $pos1=strripos($rs->contenido,'<hr />');
    $contenido1=substr($rs->contenido, 0,$pos1);
    $contenido1.='</body></html>';
    $contenido2='<!DOCTYPE html>
                <html>
                <head>
                </head>
                <body>';
    $contenido2.=substr($rs->contenido, $pos1+6);
