...
<p align="right">
    <font size="2">
     <a href="frmTrans.php?user=<?php echo $user ?>"><img src="images/boton_volver.png" width="98" height="44"></a> <!--<a href="logout.php">| Cerrar Sesión |</a>--></font></p>
  ...
  <?php $i = 0;
	...
	while ((!$reg_codice->EOF)) {
      ...
      <tr> 
        ...
        <td align="center"><a href="frmControlMant.php?placa=<?php echo $reg_codice->fields["placa"];?> & user=<?php echo $user ?>"><img src="images/ver.png" width="41" height="36"></a></td>   
