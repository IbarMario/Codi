$(document).ready(function(){
	...
	var reqDescripcion = $("#req-descripcion");
	...
	function validateDescripcion(){
			reqDescripcion.removeClass("error");
...
//funciones de validacion
	...
	inputTelefono.blur(validateTelefono);
	...
	inputTelefono.keyup(validateTelefono);
	inputDescripcion.keyup(validateDescripcion);

// Envio de formulario
	$("#f1").submit(function(){
///		if(validateUsername() & validatePassword1() & validatePassword2() & validateEmail())
		if(validateTelefono() & validateDescripcion())
			return true;
		else
			return false;
	});
