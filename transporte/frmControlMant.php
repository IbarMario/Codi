...
<p align="right">
    <font size="2">
    <a href="frmVehiculos.php?user=<?php echo $user ?>"><img src="images/boton_volver.png" width="98" height="44"></a></p>
<?php
	   $sql_codice1 = "SELECT
						tra_vehiculo.placa,
						tra_vehiculo.marca,
...
<table width="224">
  <tr>
    <td><a href="frmMantenimiento.php?placa=<?php echo $placa;?> & user=<?php echo $user ?>"><img src="images/nuevo_control.png" width="40" height="36"><br>
Control</a></td>
...
<table class="table table-striped" id="example">
  ...
  <?php $i = 0;
		 	   ...
		 	   $sql_codice = "SELECT
								...
								ORDER BY tra_mantenimiento.fecha_mant DESC";	     
	...
	while ((!$reg_codice->EOF)) {
      ...
      <tr> 
        ...
        <td align="center"><a href="frmMantenimientoEdit.php?id=<?php echo $reg_codice->fields["id"];?> & user=<?php echo $user ?> & placa=<?php echo $reg_codice->fields["placa"];?>"><img src="images/edit.png" width="41" height="36" title="Editar registro"></a></td>   
