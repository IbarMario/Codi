...
<br />
  ...
  <h3><span class="bold">SEGUIMIENTO USUARIO</span>
  </h3></div>
  <p align="right">
    <a href="index.php?user=<?php echo $user;?>"><img src="images/boton_volver.png" width="98" height="44"></a></p><br><br>
      ...
      <tr> 
        ...
        <td align="center">        	
        	<?php 
				...
				if($atendido == 0){
					echo '<img src="images/b_amarillo.png" width="34" height="30" title="En espera">';
					}
				elseif($atendido == 1){
				?>	
                	<a href="rptSolicitud.php?eec=<?php echo $at; ?>" target="_blank"><img src="images/print.png" width="34" height="34"></a>
				<?php	}
				elseif($atendido == 3){
					echo '<img src="images/cerrar.png" width="34" height="34" title="Solicitud rechazada">';
					}	
				elseif($atendido == 4){
					echo '<img src="images/ok.jpg" width="30" height="30" title="Solicitud atendida">';
					}	
	
				else{
					echo '<img src="images/b_amarillo.png" width="34" height="30">';
					}
