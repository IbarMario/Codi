...
<p align="right">
    <font size="2"><b> <?php echo $usuario;?><br></b></font>
...
<table class="table table-striped" id="example">
  ...
  <?php $i = 0;
		 	   ...
		 	   $sql_codice = "SELECT
								...
								FROM
								tra_solicitud
								ORDER BY tra_solicitud.id DESC";	     
	...
	while ((!$reg_codice->EOF)) {
      ...
      <tr> 
        ...
        <td align="center"><a href="frmVerSeguimientoMas.php?id=<?php echo $eec ?> & user=<?php echo $user ?>"><?php echo $reg_codice->fields["formulario"];?></a></td>
        ...
        <td align="left"><?php echo $reg_codice->fields["tipo"];?><br><?php echo $reg_codice->fields["placa"];?></td>
        <td align="center">
          ...
          <?php 
				...
				if($atendido == 0){
			?>
          		<!--<img src="images/b_amarillo.png" width="45" height="34">-->
                <a href="frmAsignarV.php?eec=<?php echo $eec ?> & user=<?php echo $user ?>"><img src="images/b_amarillo.png" width="45" height="34" title="Asignar vehículo"></a>
          <?php
                  }
				elseif($atendido == 1){
					?>
          <a href="rptSolicitud.php?eec=<?php echo $eec ?>" target="_blank"><img src="images/print.png" width="34" height="34"></a>	
          <a href="frmVerSeguimientoAtendida.php?eec=<?php echo $eec ?>"><img src="images/ok.jpg" width="18" height="18"></a>
          <?php
                  }
	elseif($atendido == 3){
					?>
	          <img src="images/cerrar.png" width="34" height="34" title="Solicitud rechazada">
          <?php
                  }				  
	elseif($atendido == 4){
					?>
	          <img src="images/ok.jpg" width="30" height="30">
          <?php
                  }				  
				else{
					?>
          		<!--<a href="frmAsignarV.php?eec=<?php echo $eec ?> & user=<?php echo $user ?>"><img src="images/b_verde.png" width="45" height="34" title="Asignar vehículo"></a>-->
                <img src="images/b_verde.png" width="45" height="34" title="Esperando aprobación">
          <?php
                  }
			?>
