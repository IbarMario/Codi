...
echo '<script type="text/javascript">window.location.href="rptReporteGas.php?f1="+f1+"&f2="+f2 </script>';
}
?>
	<head>
...
<br />
  ...
  <div align="center">
      <h1><span><strong><BR>
  REPORTE TRANSPORTE MDPyEP</strong></span>
</h1></div>
<div align="center">
...
<table class="table table-striped" id="example">
    ...
    <tr>
      <td colspan="4" align="center"><a href="frmSolicitudGasolina.php?user=<?php echo $user ?>">
