...
<table class="table table-striped" id="example">
  <thead>
      <tr>
        ...
        <th width="111">solicitud mantenimiento</th>
        </tr>
      </thead>
    <tbody>
  <?php $i = 0;
	...
	while ((!$reg_codice->EOF)) {
      ...
      <tr> 
        ...
        <td align="center"><a href="frmSolicitudMantPrev2.php?placa=<?php echo $reg_codice->fields["placa"];?> & user=<?php echo $user ?>"><img src="images/mantenimiento_logo.png" width="38" height="33"></a></td>   
