...
class Model_data extends Kohana_Model{
    ...
    public function oficinas_ext($id, $id_entidad){
        $sql="SELECT o.id, o.oficina FROM vias v, users u, oficinas o where v.id_usuario = '$id' AND v.id_destinatario = u.id AND u.id_entidad <> '$id_entidad' AND u.id_oficina = o.id ORDER BY o.oficina ASC";
        return DB::query(1, $sql)->execute();
    }
