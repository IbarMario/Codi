            ...
            if (isset($_POST['submit'])) {
				...
				if (isset($_POST['cartas'])) {					
					$contenido ='<body marginheight="0" marginwidth="0" topmargin="0">
									<p align="justify">De mi consideración:</p></br><br>
									<p align="justify">Mediante la presente, me dirijo '.$_POST['carta1'].' </p></br><br>
									<p align="justify">En ese entendido, '.$_POST['carta2'].' </p></br><br>
									<p align="justify">'.$_POST['despedida'].'</p>
									</body>';
				}
				////
