...
class Controller_Reportes extends Controller_DefaultTemplate{
    ...
    public function action_buscar_documentos()
    {
      if (isset($_GET['submit'])) {
            ...
            if($_GET['nur']!='' || $_GET['codigo']!='' || $_GET['remitente']!='' || $_GET['cargo_remitente']!='' || $_GET['destinatario']!='' || $_GET['cargo_destinatario']!='' || $_GET['institucion']!='' || $_GET['referencia']!='')
	     //// if($_GET['nur']!='' || $_GET['codigo']!='' || $_GET['remitente']!='' || $_GET['institucion']!='' || $_GET['referencia']!='')
            {
            ...
            $count= $oDocumento->contarDocumentos($_GET['id_entidad'],$_GET['nur'],$_GET['codigo'],$_GET['remitente'],$_GET['cargo_remitente'],$_GET['destinatario'],$_GET['cargo_destinatario'],$_GET['institucion'],$_GET['referencia'],$fecha1,$fecha2);
           //// $count= $oDocumento->contarDocumentos($_GET['id_entidad'],$_GET['nur'],$_GET['codigo'],$_GET['remitente'],$_GET['institucion'],$_GET['referencia'],$fecha1,$fecha2);
            $count=$count[0]['count'];
      ...
      'total_items'    => $count,
            ...
            $results=$oDocumento->buscarDocumentos($_GET['id_entidad'],$_GET['nur'],$_GET['codigo'],$_GET['remitente'],$_GET['cargo_remitente'],$_GET['destinatario'],$_GET['cargo_destinatario'],$_GET['institucion'],$_GET['referencia'],$fecha1,$fecha2,$pagination->offset,$pagination->items_per_page);            
          ////  $results=$oDocumento->buscarDocumentos($_GET['id_entidad'],$_GET['nur'],$_GET['codigo'],$_GET['remitente'],$_GET['institucion'],$_GET['referencia'],$fecha1,$fecha2,$pagination->offset,$pagination->items_per_page);            
            
            $page_links = $pagination->render();

            $texto_array = array($_GET['nur'],$_GET['codigo'],$_GET['remitente'],$_GET['cargo_remitente'],$_GET['destinatario'],$_GET['cargo_destinatario'],$_GET['institucion'],$_GET['referencia']);
           //// $texto_array = array($_GET['nur'],$_GET['codigo'],$_GET['remitente'],$_GET['institucion'],$_GET['referencia']);
