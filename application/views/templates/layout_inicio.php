...
<meta http-equiv="Content-type" content="text/html; charset=UTF-8" />
    ...
    <style>
		.estilo1{color:red;background:blue;}
	</style>
</head>
<body>
    <div id="top">
        <div id="modx-topbar">
            <a href="../../../codice2/index.php" target="_blank"><div id="modx-site-name">
            Codice  <span class="modx-version">Correspondencia Digital Centralizada</span>
          </div></a>
            <div id="modx-logo">
                <div id="find">
