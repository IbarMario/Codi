...
<body>
    <div id="top">
        <div id="modx-topbar">
            ...
            <div id="modx-logo">
                <div id="find">
                    <a href="/reportes/buscar_documentos" style="line-height: 20px; height: 30px; float:left; color:#FFFFFF" title='Realiza la busqueda de la gestion anterior'><strong>| <u>B&uacutesqueda Avanzada</u> |</strong>&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    <form action="/busqueda" method="GET">           
                        <input type="text" name="txt_buscar" class="txt_buscar" style="line-height: 20px; height: 25px; font-size: 13px; width: 200px;" title='Realiza la busqueda solo de la gestion actual. Si necesita de otras gestiones puede ir a busqueda avanzada '/>
