...
<!-- <li>
     <div style="background:#cffc98">
      <a class="itemd" href="/rcintranet/index.php" onclick="window.open(this.href, this.target, 'width=1025,height=730,left=470,top=77,scrollbars=1'); return false;">
      <strong>Registro de Comercio</strong><br/>
     <span>
 ...
 <li>
    <div>
      <a href="/transporte/index.php?user=<?php echo $user->id;?>" onclick="window.open(this.href, this.target, 'width=1025,height=730,left=470,top=77,scrollbars=1'); return false;">
     </a>
     </div>
    </li>
