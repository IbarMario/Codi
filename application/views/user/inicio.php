...
<form name="Switch" id="Switch">
    <div>
            ...
            <p>
              <font color="#3974cc" face="Verdana" ><input name="A" size="7" style=
                "color: #252fe9; font-weight: bold; font-size:20px; font-family: Verdana, Arial; background-color: rgb(255,255,255); border: 0px outset rgb(0,128,0); margin-top: auto; padding-left: 5px" /></font>
...
//<![CDATA[
    ...
    <li>
        <div style="background:#b7cce8">
            <a class="itemd" href="http://form.produccion.gob.bo?user=<?php echo $user->id;?>" target="_blank" return false>
    ...
    <li>
        <div style="background:#ffe692">
            <a class="itemd" href="/intranet/index.php" onclick="window.open(this.href, this.target, 'width=1080,height=730,left=470,top=77,scrollbars=1'); return false;">
            <strong>IntraNet 2.0</strong><br/>
            <span>
               Documentos, Circulares, Directorio Telefónico, otros
            </span>
            </a>
        </div>
    </li>
    <li>
        <div>
            <a href="/transporte/index.php?user=<?php echo $user->id;?>" onclick="window.open(this.href, this.target, 'width=1025,height=730,left=470,top=77,scrollbars=1'); return false;"></a>
        </div>
    </li>
    */?>
</ul>    
...
<?php if($user->id_entidad==0 ): //0=deshabilitar, 1=habilitar aviso para MDPyEP ?>
...
<div align="right"><a href="javascript:closeit()" title="Cerrar"><font color="white"><b><img src="../../../intranet/images/cerrar.png" width="30" height="30" /></b></font></a></div> 
<center>



<!--------------- Ventana de link descarga  -------------- -->





<img src="../../../intranet/images/COMUNICADO.jpg" width="650" height="440" usemap="#descargas"/>
<!--<a href="../../../intranet/images/INSTRUCTIVO_030817.pdf" title="Descargar" target="_blank">
Descargar    
</a>-->
<map name="descargas">
    <area alt="Descargar PDF" shape="rect" coords="187,295,295,405" href="../../../intranet/images/propuesta_quipus.docx">
    <area alt="Descargar Word" shape="rect" coords="352,295,458,405" href="../../../intranet/images/plan_de_pagos_2017_MDPyEP.pdf" target="_blank">
</map>
...
background:#afafaf;color:#ccc;border:4px solid #95b1cf; 
z-index:100;font:20px verdana;width:660px;padding:3px;height:480px;} 
