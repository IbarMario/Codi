        ...
        <tbody>
         <tr>
             <td colspan="2">
                ...
                <input type="checkbox" value="1" id="urgente" /> 
                Urgente</td>                        
         </tr>
         <tr>
             <td >
        ...
        <tr>            
            ...
            <td align="right">                
             ...
             <!--   <a href="/print_hr.php?nur=<?php echo $documento->nur;?>" target="_blank" class="uiButton"><img src="/media/images/printer.png" alt="" align="absmiddle"/> Imprimir  HR</a> -->
                ...
                <!-- <a href="/print_hr.php?nur=<?php echo $documento->nur;?>&copia=0" target="_blank" class="uiButton"><img src="/media/images/printer.png" alt="" align="absmiddle"/> Imprimir  HR Original</a>   
                 <a href="/print_hr.php?nur=<?php echo $documento->nur;?>&copia=1" target="_blank" class="uiButton"><img src="/media/images/printer.png" alt="" align="absmiddle"/> Imprimir  HR Copia</a> -->         
                 
				<!--<a href="/imprimirHR.php?nur=<?php echo $documento->nur;?>" target='' onclick=\"window.open(this.href, this.target, ' width=1000, height=800, menubar=no');return false;\" class="uiButton"><img src="/media/images/printer.png" alt="" align="absmiddle"/> Imprimir HR </a>-->
               <a href="/imprimirHR.php?nur=<?php echo $documento->nur;?>" target="_blank" onclick="window.open(this.href,this.target,'width=400,height=250,top=400,left=500,toolbar=no,location=no,status=no,menubar=no');return false;" class="uiButton"><img src="/media/images/printer.png" alt="" align="absmiddle"/> Imprimir  H.R.</a>&nbsp;&nbsp;&nbsp;&nbsp;
                <?php //endif;?>
            </td>
        </tr>
</table>
