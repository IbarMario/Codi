...
<div id="popup_name" class="popup_block">  
    <form method="post" action="/hojaruta/responder" id="form_respuesta">    
        <table class="classy">
            <thead>
                <tr>
            ...
            <tbody>
                <tr>
                    <td style=" height: 50px; ">
                        ...
                        echo Form::hidden('fucov', '', array('id' => 'fucov'));
                                ...
                                <div>
                                    ...
                                    <span class="oficina">Procedencia: <b><?php echo $s->de_oficina; ?></b><span><br/>
                                            ...
                                            <td class="derecha" valign="top">
                                                <div>
                                                    <span><b>F.Recepción: </b><?php echo Date::fecha($s->fecha2); ?></span>
							  <?php $fec = $s->fecha2;  
                                                        $fecpen = substr($fec,10,16);
                                                    ?>
                                                    <span><b> &nbsp;&nbsp;&nbsp; </b><?php echo $fecpen;?></span><br/><br/>
                                                    ...
                                                    <span><b>Archivo Adj.: </b>
                                                        ...
                                                        foreach ($archivos as $a) {
                                                            ?>
									<!--  Ocultar adjuntos pdf de la bandeja pendientes efrain   -->
