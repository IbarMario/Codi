    ...
    <table class="oficial<?php echo $s->oficial;?>">
        <tr>
            ...
            <td class="derecha" valign="top">
                                <div>
                                    <span><?php echo Date::fecha($s->fecha);?></span>&nbsp;&nbsp;&nbsp;
                                    <?php $fec = $s->fecha;  
                                    $fecent = substr($fec,10,16);
                                    ?>
                                    <span><?php echo $fecent;?></span><br/><br/>
							...
							<!-- ocultar los pdf de la bandeja de entrada..   -->
         ...
         <tr>
             ...
             <td colspan="2">
                <span class="opciones">
					...
					<!-- cancelar derivacion de la bandeja de entrada  -->
