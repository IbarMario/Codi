 ...
 <div class="descripcion" style="width: 800px; float: left; ">
            ...
            <div id='contenido4' style="width: 780px;">
                ...
                <p align="justify"><strong>VISTOS:</strong><br />
                  ...
                  Que la Resolución Ministerial MDPyEP/DESPACHO Nº  059/2010 de fecha 1 de abril de 2010, aprueba el Procedimiento de Resolución de  Trámites para el Registro de Comercio.<br />
  </p>
                <p align="justify">&nbsp;</p>
                <p align="justify"><strong>CONSIDERANDO:&nbsp;</strong></p>
                <p>Que mediante solicitud de  fecha
                  <input type="text" id="fecha" name="fecha" size='30'/>
                presentado por el (a) señor(a) 
