...
<div  style="width: 800px;   border: 1px solid #eee; height: 100%;  ">  
    <table style=" width: 100%;">
        <tbody>
			...
			<!-- Los archivos adjuntos pdf de la bandeja de entrada y pendientes  -->
...
<?php if ($d->fucov == 1) {
    if ($pvcomision->observacion!='') {
        ?>   
        <tr>
            <td colspan="3"><b>Observación:</b></td>
        </tr>   
        <tr>
            <td colspan="3">
                <div style="overflow:auto; width: 670px; text-align: justify">
                   <?php echo $pvcomision->observacion;?>
               </div>
           </td>
       </tr>         
<?php        
