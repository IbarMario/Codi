...
<div class="formulario">
    <form action="/documento/crear/<?php echo $documento->action;?>" method="post" id="frmCreate">
        <br/>
        <fieldset>
            <?php if($tipo->tipo=='Cartas' || $tipo->id == '16'):
            ...
            <legend>Proceso: <?php echo Form::select('proceso', $options, NULL);?>
                ...
                <!--    CARTA - EFRAIN ESPINOZA -->
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
          <?php if ($documento->tipo == 'Resolucion Administrativa'){?>R.A-H.R: <?php echo Form::checkbox('adm',1,FALSE,array('id'=>'adm','name'=>'adm'))?><?php  }?>

                <!-- FIN CARTA EFRAIN ESPINOZA  -->
...
<tr>
    <td colspan="2" style="padding-left: 5px;">
        ...
        <textarea name="referencia" class="required" id="referencia" style="width: 500px;"><?php echo $referencia ?></textarea>
...
<div class="descripcion" style="width: 800px; float: left; ">
            ...
            <div id='contenido4' style="width: 780px;">
                ...
                <p align="justify"><strong>VISTOS:</strong><br />
                  ...
                  Que en mérito al Decreto Supremo No 0071,  promulgado en fecha 09 de abril del 2009, es atribución de la Ministra o Ministro de  Desarrollo Productivo y Economía Plural, administrar el Registro de Comercio,  según lo establecido por el Artículo 43, inciso i) de la mencionada norma.<br />
