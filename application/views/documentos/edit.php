...
$('#adm').click(function(){
    if($('#adm').is(':checked')) {
            ...
            //adicionar atributos
/*EFRA            $("#carta1").attr("class","required");
            $("#carta2").attr("class","required");
            $("#despedida").attr("class","required");
            $('#otro_nur').hide();*/
        } else {
            //$('#label_referencia').text('Referencia');
            $('#label_contenido').hide();
            ...
            //elimar atribuitos
/*             $("#descripcion").removeAttr("class");
             $("#carta2").removeAttr("class");
             $("#despedida").removeAttr("class");*/
...
<p style="text-align: justify;">En atenci&oacute;n a memorandum N&deg; '.$doc_memo->codigo.' elevo a su autoridad el presente informe de viaje realizado a la ciudad de '.$pvcomision_memo->destino.' desde el '.$diai.' '.$fi.' hasta el '.$diaf.' '.$ff.', correspondiendo informar lo siguiente:</p>
...
<h2 class="subtitulo">Editar <?php echo $documento->codigo; ?> - <b><?php echo $documento->nur; ?></b><br/>
<span> Editar documento <?php echo $documento->codigo; ?> </span></h2>
...
<!--<form action="/documento/editar/<?php echo $documento->id; ?>" method="post" id="frmEditar" >-->
                ...
                if ($documento->id_tipo == 5 || $documento->id_tipo==16):
                    ...
                    <fieldset> <legend>Proceso: <?php echo Form::select('proceso', $options, $documento->id_proceso,array('id'=>'proceso')); ?>
                            ...
                            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                           <?php if (($documento->id_tipo == '11')and (($documento->id_user == '231')or($documento->id_user == '379')or($documento->id_user == '381')or($documento->id_user == '376'))){?>R.A-H.R: <?php echo Form::checkbox('adm',1,FALSE,array('id'=>'adm','name'=>'adm',$checked))?><?php  }?>
                             &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp                          
                            <?php if (($tipo->id == '11') and (($documento->id_user <> '231')or($documento->id_user <> '379')or($documento->id_user <> '381')or($documento->id_user <> '376'))){?>
...
<div id='contenido1'>
            ...
            <div id='contenido4' style="width: 780px;">
                <br>
                <p><strong>Tipo:</strong><span style="text-align: left;">
                  ...
                  <input type="text" id="empresa" name="empresa" size='70' onkeyup="javascript:this.value=this.value.toUpperCase();"/>
                </p>
                <br />
                <p align="justify"><strong>VISTOS:</strong><br />
                  Que el Decreto Supremo No 29894 de fecha 7 de  febrero de 2009, en el tercer parágrafo de su artículo 137 establece la  extinción de la Superintendencia de Empresas. Sus competencias serán asumidas  por el Ministerio de Desarrollo Productivo y Economía Plural.&nbsp;<br />
                  Que en mérito al Decreto Supremo No 0071,  promulgado en fecha 09 de abril del 2009, es atribución de la Ministra de  Desarrollo Productivo y Economía Plural, administrar el Registro de Comercio,  según lo establecido por el Artículo 43, inciso i) de la mencionada norma.<br />
                  Que mediante Resolución Ministerial MDPyEP Despacho  No. 117/2012, de 17 de julio de 2012, se autoriza la transferencia de la Unidad  del Registro de Comercio dependiente de la Dirección General de Servicios y  Control Industrial, dependiente del Viceministerio de Producción Industrial a  Mediana y Gran Escala del Ministerio de Desarrollo Productivo y Economía  Plural, con el objetivo de conocer y resolver los trámites del Registro de  Comercio remitidos por el Concesionario (FUNDEMPRESA).&nbsp;<br />
                  Que la Resolución Ministerial MDPyEP/DESPACHO No  059/2010 de fecha 1 de abril de 2010, aprueba el Procedimiento de Resolución de  Trámites para el Registro de Comercio.<br />
  </p>
                <p align="justify">&nbsp;</p>
                <p align="justify"><strong>CONSIDERANDO:&nbsp;</strong></p>
                <p>Que mediante solicitud de  fecha
                  <input type="text" id="fecha" name="fecha" size='30'/>
                presentado por <span style="text-align: left;">
                <select name="senor" id="senor">
                  <option></option>
                  <option>el señor</option>
                  <option>la señora</option>
                </select>
                </span>
<input type="text" id="representante" name="representante" size='30'/>
                Representante Legal de la 
                
                <strong>XXXX YYYY</strong> con Matrícula de Comercio  No.
<input type="text" id="matricula" name="matricula" size='12'/>
                solicita al Ministerio de  Desarrollo Productivo y Economía Plural, la autorización del uso de hojas  removibles o tarjetas mediante medios mecánicos o electrónicos en 
                <textarea name="medios" cols="50" rows="3" id="medios"></textarea>
                </p>
                <p style="text-align: justify;">Que mediante Informe Técnico  Jurídico 
                  <input type="text" id="informe" name="informe" size='30'/>
                de fecha 
                <input type="text" id="fecha2" name="fecha2" size='30'/>
emitido por <span style="text-align: left;">
...
<input type="text" id="emitido" name="emitido" size='40'/>
<input type="text" id="cargo" name="cargo" size='40'/>
                de FUNDEMPRESA, se realiza  una interpretación de las disposiciones legales aplicables, manifestando que la <strong>XXXXX YYYYYY</strong> cumple con lo previsto en el Artículo 40 del Código  de Comercio y con los requisitos y formalidades correspondientes establecidas  para el trámite de referencia, y el Ministerio de Desarrollo Productivo y  Economía Plural debe emitir un pronunciamiento, a través de una Resolución  Administrativa, conforme a procedimiento.<br />
                  <strong>CONSIDERANDO:</strong><br />
                  Que el avance de la tecnología en materia  informática ha cambiado las técnicas de elaboración y registro de documentos  mercantiles sujetos a registro, utilizando programas computarizados diseñados  especialmente para el efecto, logrando simplificar dichos instrumentos  jurídicos, además de darle mayor seguridad jurídica, desde el punto de vista de  la materialización, a los documentos mercantiles.<br />
                  Que el Código de Comercio prevé la utilización de  estos avances tecnológicos a través del uso de conceptos indeterminados como  son “cualquier medio mecánico o electrónico”, que habilita a la autoridad  administrativa a realizar una interpretación favorable de este caso.<br />
                  Que ante la evidencia de la utilidad práctica de  los medios informáticos que han revolucionado la forma de relacionamiento entre  la Administración Pública y los Administrados, existen precedentes  administrativos que determinan favorablemente que la Unidad del Registro de  Comercio de curso a la mencionada solicitud.&nbsp;<br />
				  ...
				  <span style="text-align: left;">
						<select name="puesto" id="puesto">
						  <option></option>
						  <option>Jefe de la Unidad de Registro de Comercio</option>
						  <option>Director General de Servicios y Control Industrial</option>
						  <option>Viceministro de Producción Industrial a Mediana y Gran Escala</option>
						  <option>Viceministro de Producción Industrial a Mediana y Gran Escala a.i.</option>
						</select>
					</span>
				  ,  dependiente del Viceministerio de Producción Industrial a Mediana y Gran Escala  del Ministerio de Desarrollo Productivo y Economía Plural, de conformidad a lo  establecido en el Artículo 43 del Decreto Supremo Nº 071, de 9 de abril del  2009, concordante con las Resoluciones Ministeriales MDPyEP/DESPACHO Nº  117/2012 y MDPyEP/DESPACHO/059/2010, en ejercicio de las atribuciones y facultades  mencionadas.<br />
                <strong>RESUELVE:</strong></p>
<p align="justify"><strong>AUTORIZAR&nbsp;a&nbsp;FUNDEMPRESA</strong>, Concesionaria del Registro de Comercio, proceda a  dar curso a la solicitud efectuada por la <strong>XXXX YYYYY </strong>con Matricula de Comercio  No. <strong>ZZZZZZ</strong> del uso de hojas removibles  o tarjetas mediante medios mecánicos o electrónicos en&nbsp;<strong>MMMMMM</strong></p>
                <p align="justify">La presente Resolución Administrativa deberá ser  incorporada a la Carpeta Comercial perteneciente a la empresa, que forma parte  del archivo físico del Concesionario del Registro de Comercio (FUNDEMPRESA).<br />
                  <br />
Regístrese, comuníquese, cúmplase y archívese.</p>
                <p>&nbsp; </p>
...
<div id='contenido2' style="width: 780px;">
                            ...
                            <p align='justify;'>A través del presente memorándum, se autoriza a su persona realizar el viaje desde la <br>
                            ciudad (origen)
