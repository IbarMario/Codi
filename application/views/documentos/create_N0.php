    ...
    <form action="/documento/crear/<?php echo $documento->action;?>" method="post" id="frmCreate">
        ...
        <fieldset>
            ...
            <legend>Proceso: <?php echo Form::select('proceso', $options, NULL);?>
                ...
                <?php if ($documento->tipo == 'Carta'){?>Carta: <?php echo Form::checkbox('cartas',1,FALSE,array('id'=>'cartas','name'=>'cartas'))?><?php }?>
...
<div class="descripcion" style="width: 800px; float: left; ">
            ...
            <div id='contenido4' style="width: 780px;">
                ...
                <p align='justify;'>Mediante la presente, me dirijo 
                  <textarea name="carta1" id="carta1" style="width: 775px;" ></textarea>
                </p><br />
                <p style="text-align: left;">En ese entendido,
                  <textarea name="carta2" id="carta2" style="width: 775px;" ></textarea>
                </p>
                <p style="text-align: left;">
                  <select name="despedida" class="required">
                    <option>Sin otro particular, se despide muy atentamente,</option>
                    <option>Con este motivo, me despido con las atenciones más distinguidas.</option>
