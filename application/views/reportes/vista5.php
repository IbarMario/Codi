...
$(function(){
    //$("#texto").resaltar("freddyxx", "resaltarTexto"); 
    <?php foreach ($texto_array as $v) { ?>
        $("#texto").resaltar("<?php echo $v ?>", "resaltarTexto");
    //$("#texto").resaltar("<?php echo 'Freddy' ?>", "resaltarTexto");    
    <?php } ?>
...
<h2 class="subtitulo">Resultados<br/><span><b><?php echo $count;?></b> resultados encontrados para <b>'<?php print implode(' , ',$texto_array);?>'</b></span></h2>
<?php if($count>0){?>
<br/>
