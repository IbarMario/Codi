...
try {
  ...
  //  $image_file = 'media/logos/'.$rs->logo;
   // $pdf->Image($image_file, 12, 12, 55, 25, 'png', '', '', false, 300, '', FALSE, FALSE, 0);
    ...
    $pdf->Image('escudo_b.png' , 25 ,14, 20 , 20,'PNG', '');
    $image_file = 'media/logos/'.$rs->logo;
 ...
 ////   $pdf->Cell(75, 20, 'Ministerio de Desarrollo Productivo y Economia Plural', 0,FALSE,'C'); 
	...
	$pdf->Line(170,162,170,205);
	$pdf->Line(210,162,210,205);
	...
	$pdf->Line(170,226,170,269);
	$pdf->Line(210,226,210,269);
	...
	$pdf->Line(170,36,170,78);
	$pdf->Line(210,36,210,78);

	$pdf->Line(130,68,210,68);
	$pdf->Line(130,73,210,73);
	$pdf->Line(130,78,210,78);

	$pdf->Line(170,99,170,141);
	$pdf->Line(210,99,210,141);
	...
	$pdf->Line(170,162,170,204);
	$pdf->Line(210,162,210,204);
	...
	$pdf->Line(170,225,170,267);
	$pdf->Line(210,225,210,267);	
