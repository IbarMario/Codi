...
if ( $archivo != "none" ){
	...
	$qry = "INSERT INTO tbl_reglamentos( titulo,nombre_archivo, descripcion, contenido, tamanio,tamanio_unidad, tipo, fecha ) VALUES
	...
	echo '<a href="frmRegistrarReg.php">Subir otro Archivo...</a><br > ';
