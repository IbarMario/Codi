...
if ( $archivo != "none" ){
	...
	$qry = "INSERT INTO tbl_descargar ( titulo,nombre_archivo, descripcion, contenido, tamanio,tamanio_unidad, tipo, fecha ) VALUES
	...
	echo '<a href="frmRegistrarDes.php">Subir otro Archivo...</a><br > ';
