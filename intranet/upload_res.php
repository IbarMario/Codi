...
if ( $archivo != "none" ){
	...
	$qry = "INSERT INTO tbl_resoluciones( titulo,nombre_archivo, descripcion, contenido, tamanio,tamanio_unidad, tipo, fecha ) VALUES
	('$titulo','$nombre_archivo', '$descripcion','$contenido','{$tamanio[0]}','{$tamanio[1]}', '$tipo', '$fecha')";
	...
	echo '<a href="frmRegistrarRes.php">Subir otro Archivo...</a><br > ';
	echo '<br><a href="frmRegistrar.php">Salir</a><br > ';
}else{
	echo '<br>';
