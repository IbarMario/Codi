...
<br />
  ...
  <div align="center">
    <H1><strong><font color="#003399">COMUNICADOS</font></strong></H1>
  </div>
<table class="table table-striped" id="example">
  ...
  <?php $i = 0;		 
      ...
      <!--  <td align="left"><font size="1"><?php echo $reg_codice->fields["descripcion"];?></font></td>-->
        <td align="center"><a href='getfileCom.php?id_documento=<?php echo $id; ?>'><img src="images/descargar.png" width="60" height="35"></a></td>        
      </tr>
