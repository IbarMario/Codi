...
<br />
  ...
  <p>
  <form id="test_upload" name="test_upload" action="upload_des.php" enctype="multipart/form-data" method="post">
	 <div align="center">
      <table align="center" width="200" border="0" cellspacing="1" cellpadding="1">
		...
		<tr>
			<td colspan="2">
				<font color="#FF0000">Archivo solo en formtato Imagen - .jpg, .png</font> <input type="file" id="archivo" name="archivo"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" align="center">
				<input class="btn btn-success btn-cons" type="submit" value="Registrar Descarga"/>
			</td>
		</tr>
	</table></td>
	      </tr>
