...
if ( $archivo != "none" ){
	...
	$qry = "INSERT INTO tbl_documentos ( titulo,nombre_archivo, descripcion, contenido, tamanio,tamanio_unidad, tipo, fecha ) VALUES
	...
	echo '<a href="frmRegistrarDoc.php">Subir otro Archivo...</a><br > ';
