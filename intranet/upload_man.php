...
if ( $archivo != "none" ){
	...
	$qry = "INSERT INTO tbl_manuales( titulo,nombre_archivo, descripcion, contenido, tamanio,tamanio_unidad, tipo, fecha ) VALUES
	...
	echo '<a href="frmRegistrarMan.php">Subir otro Archivo...</a><br > ';
