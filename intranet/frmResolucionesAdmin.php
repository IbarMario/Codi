...
<br />
  ...
  <div align="center">
    <H1><strong><font color="#003399">RESOLUCIONES</font></strong></H1>
  </div>
  <p align="right"><a href="frmRegistrar.php"><img src="img/Volver.jpg" width="106" height="49"></a></p>
  <p>
<a href='frmRegistrarRes.php'><img src="images/add.png" width="34" height="35"> <br>Adicionar</a> 
...
<table class="table table-striped" id="example">
  ...
  <?php $i = 0;		 
      ...
      <!--  <td align="left"><font size="1"><?php echo $reg_codice->fields["descripcion"];?></font></td>-->
        <td align="center"><a href='getfileRes.php?id_documento=<?php echo $id; ?>'><img src="images/descargar.png" width="60" height="35"></a></td> 
        <td align="center"><a href='frmRegistrarResAdminMod.php?id=<?php echo $id; ?>'><img src="images/editar.png" width="34" height="35"></a></td> 
        <td align="center"><a href='frmRegistrarResAdminEli.php?id=<?php echo $id; ?>'><img src="images/eliminar.jpg" width="40" height="35"></a>        
        </td>        
      </tr>
