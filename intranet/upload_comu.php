...
if ( $archivo != "none" ){
	...
	$qry = "INSERT INTO tbl_comunicados( titulo,nombre_archivo, descripcion, contenido, tamanio,tamanio_unidad, tipo, fecha ) VALUES
	...
	echo '<a href="frmRegistrarCom.php">Subir otro Archivo...</a><br > ';
