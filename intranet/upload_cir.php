...
if ( $archivo != "none" ){
	...
	$qry = "INSERT INTO tbl_circulares( titulo,nombre_archivo, descripcion, contenido, tamanio,tamanio_unidad, tipo, fecha ) VALUES
	...
	echo '<a href="frmRegistrarCir.php">Subir otro Archivo...</a><br > ';
