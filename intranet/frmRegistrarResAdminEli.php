...
if (isset($_POST["Enviar"])) {
		$sql_insert = $conn->Execute("DELETE FROM tbl_resoluciones 
									 WHERE id_documento = '$id'");	

	echo '<script type="text/javascript">window.location.href="frmResolucionesAdmin.php" </script>';
}
?>
<head>
...
<br />
  ...
  <div align="center"><br>
  <H1><strong><font color="#003399">ELIMINAR RESOLUCIÓN </font></strong></H1>
  </div>
      ...
      <table align="center" width="200" border="0" cellspacing="1" cellpadding="1">
		...
		<tr>
			<td colspan="2" align="center">
				<input type="submit" class="btn btn-danger btn-cons" name="Enviar"  value="Eliminar Resolución" id="Enviar"/>
