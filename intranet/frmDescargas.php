...
<br />
  ...
  <div align="center">
    <H1><strong><font color="#003399">DESCARGAS</font></strong></H1>
  </div>
<table class="table table-striped" id="example">
  ...
  <?php $i = 0;		 
      ...
      <tr> 
        ...
        <td align="left"><font color="#000099"><a href='getfileDes.php?id_documento=<?php echo $id; ?>'><?php echo $reg_codice->fields["titulo"];?></a></font><br><font size="1"><?php echo $reg_codice->fields["descripcion"];?></font></td>
        <td align="center"><a href='getfileDes.php?id_documento=<?php echo $id; ?>'><img src="images/descargar.png" width="68" height="46"></a></td>        
      </tr>
