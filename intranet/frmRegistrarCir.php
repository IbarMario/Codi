...
<br />
  ...
  <div align="center"><br>
  <H1><strong><font color="#003399">CIRCULARES</font></strong></H1>
  </div>
  <p align="right"><a href="frmRegistrar.php"><img src="img/Volver.jpg" width="106" height="49"></a></p>
  <p>
  <form id="test_upload" name="test_upload" action="upload_cir.php" enctype="multipart/form-data" method="post">
	 <div align="center">
      <table align="center" width="200" border="0" cellspacing="1" cellpadding="1">
		...
		<tr>
			<td colspan="2" align="center">
				<input class="btn btn-success btn-cons" type="submit" value="Registrar Circular"/>
			</td>
		</tr>
	</table></td>
	      </tr>
