...
<br />
  ...
  <div align="center">
  <H1><strong><font color="#003399">AVISOS</font></strong></H1>
  </div>
  <div align="right"><a href="frmRegistrar.php"><img src="img/Volver.jpg" alt="" width="106" height="49"></a></div>
  <p>
  <form id="test_upload" name="test_upload" action="upload_avi.php" enctype="multipart/form-data" method="post">
  <div align="center">
	  <table align="center" width="200" border="0" cellspacing="1" cellpadding="1">
		...
		<tr>
			<td colspan="2">
				<font color="#FF0000">Archivo en formato imagen (.jpg, .png)</font> <input type="file" id="archivo" name="archivo"/>
			</td>
		</tr>
		<tr>
			<td colspan="2" align="center">
				<input class="btn btn-success btn-cons" type="submit" value="Registrar Aviso"/>
			</td>
		</tr>
	</table></td>
	      </tr>
