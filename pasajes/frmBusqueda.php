...
echo '<script type="text/javascript">window.location.href="frmPasajesFechas.php?f1="+f1+"&f2="+f2 </script>';
}
?>
	<head>
...
<table class="table table-striped" id="example">
    <tr>
      <td colspan="4">Busqueda por fecha:</td>
      </tr>
    <tr>
      <td colspan="4"></td>
      </tr>
    ...
    <tr>
      <td colspan="4" align="center"><a href="frmPasajes.php">
      <input type="button" name="Cancelar" value="CANCELAR" class="btn btn-warning btn-cons" id="Cancelar" /></a>
      <input type="submit" name="Enviar" value="BUSCAR" class="btn btn-primary btn-cons" id="Enviar" />
      </td>
      </tr>
  </table>
</form>  
