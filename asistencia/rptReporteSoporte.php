...
echo '<script type="text/javascript">window.location.href="rptReporteSoportePrint.php?f1="+f1+"&f2="+f2 </script>';
}
...
<h3 align="center"><img src="images/logo_mdp.jpg" width="370" height="90"></h3>
...
?> 
<a href="rptReporteSoportePrint.php?f1=<?php echo $f1 ?> & f2=<?php echo $f2 ?>" target="_blank">IMPRIMIR </a>
