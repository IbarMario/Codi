...
<div class="container">
	...
	<div class="grid-body ">
    <div align="center">
  <h3><img src="images/baner_soporte.jpg" width="749" height="165" align="middle"></h3>
...
<form name="f1" action="" method="post">
    <div align="center">
      ...
      <tr>
      <td align="center"><font size="2"><a href="frmSeguimientoUser.php?user=<?php echo $user;?>">        Ver Seguimiento</a></font></td>
      <td align="right"><a href="documentos/PROCEDIMIENTO SOPORTE TECNICO.pdf" target="_blank">Manual de Usuario </a></td>
      ...
      <tr>
        ...
        <!--<td width="291"><input name="telefono" type="text" maxlength="15" onKeyPress="javascript:return validarNro(event)" /></td>-->
      ...
      <tr>
        <td>
          ...
          <p>
            <input type="checkbox" name="a3" value="Impresora" /> Impresora - Scanner</p>          <p>
        ...
        <textarea name="descripcion" cols="50" rows="10"></textarea></td>
        </tr>
       <tr>
       <th colspan="4" align="center"><input type="submit" name="Cancelar" value="Cancelar" class="btn btn-warning btn-cons" id="Cancelar" onClick="window.close();"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;        <input type="submit" name="Enviar" value="Enviar" class="btn btn-danger btn-cons" id="Enviar" /></th>
       </tr>
    </table>
</form>
	</div>
