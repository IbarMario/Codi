...
//echo "Identificacion Cliente-> ".$clieUid;
//echo "Authenticated-> ".$_SESSION[SITE]["authenticated"];
//echo "Session identifi usr-> ".$_SESSION[SITE]["usr_uid"];
if( $_SESSION[SITE]["authenticated"]===true && $clieUid === $_SESSION[SITE]["usr_uid"] ) {       
