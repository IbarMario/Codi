...
if( $db3->numrows() > 0 ) {
    ...
    $sql = " INSERT INTO sys_users ( usr_login, usr_pass, usr_email, usr_nombres, usr_paterno, usr_materno, usr_ci, usr_ci_exp, usr_status, usr_delete, usr_sw_ref, usr_datecreate, usr_dateupdate, usr_usuario_id) "
            ." VALUES ( '".$matricula."', '".$passwd."', '".$sEmail."', '".$nombres."', '".$paterno."', '".$materno."', '".$ciuser."', '".$expciusr."', 'INACTIVE', '0', '1', NOW(), NOW(), '".$usuarioid."' )";
      //echo $sql;
    //Registro realizado
    if( $db->numrows() > 0 ) {
