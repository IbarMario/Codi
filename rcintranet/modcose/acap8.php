        ...
        <fieldset>
          <table width="100%" class="fOpt" >
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input type="text" name="input-1"  onblur="javascript:saveUPD(1); return false;" id="input-1" value="<?php echo number_format($aGestion["rege_valor"], 0, '.', ','); ?>" size="20" maxlength="14" class="inpB2 numeric" />
                ...
                <tr>
                    ...
                    <td align="center"  >
                    <input type="text" name="input-2"  onblur="javascript:saveUPD(1); return false;" id="input-2" value="<?php echo number_format($aGestion["rege_valor"],0, '.', ','); ?>" size="20" maxlength="14" class="inpB2 numeric" />
