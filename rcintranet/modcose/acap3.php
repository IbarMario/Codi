            ...
            <tr>
                ...
                <td> 
                    ...
                    <input type="text" name="input-8" id="input-8" value="<?php if ($estado > 0){ 
                        echo $aSuministro["sumi_categoriatarifaria"];} else {echo ('');}  ?>" <?php echo $mostrar; ?>  size="60"  class="inpC2"  onKeyUp="this.value = this.value.toUpperCase();" required pattern="[A-Z ]*">                    
