...
$estado = $aOtrosgastos["otga_estado"];
//echo $estado;
?>
        ...
        <fieldset>
          ...
          <table width="50%" class="fOpt" >
                ...
                <tr>
                    ...
                    <input type="text" name="otros_gastos" maxlength="14" onblur="javascript:saveUPD(1); return false;" id="otros_gastos" value="<?php if ($estado > 0){echo number_format($aOtrosgastos["otga_valor"]);} else {echo"";}; ?>" class="numeric inpB2" />
                    <span id="div_otros_gastos" class="bxEr" style="display:none" >requerido</span>
                    <span id="div_otros_gastos_2" class="bxEr" style="display:none" >inv�lido</span>
                    </td>
                </tr>
                </tbody>
            </table>                      
