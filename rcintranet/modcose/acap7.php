...
?>
    ...
    <tbody>
        ...
        <tr>                        
            <td colspan="2"><b>Paso 1.- </b>Introducir el monto correspondiente al TOTAL VENTAS, Total Ventas al Mercado Nacional se calcula automaticamente y presionar Tab.<br>
                <b>Paso 2.-</b> Introducir el monto que corresponde a Total Ventas a Mercado Externo, 1.1 Total Ventas al Mercado Nacional y se calcula automaticamente al igual que c. Venta a Personas Particulares, presiona Tab<br>
                <b>Paso 3.-</b> Introducir el monto b. Ventas a Empresas Privadas, 1.1 Total Ventas al Mercado Nacional y se calcula automaticamente al igual que c. Venta a Personas Particulares presiona Tab.<br>
                <b>Paso 4.-</b> Introducir el monto a. Ventas a Instituciones Públicas, 1.1 Total Ventas al Mercado Nacional y se calcula automaticamente al igual que c. Venta a Personas Particulares presiona Tab.<br>
                </td>    
        </tr>
    </tbody>
    </table>    
    <form class="formA validable" action="acap7Add.php" method="post" autocomplete="off" >
        <fieldset>
          ...
          <table width="100%" class="fOpt"  >
                ...
                $sql = " SELECT vese_defi_uid, vese_valor, vese_estado "
                ...
                while( $aMercaderia = $db->next_record() ) {
                    ...
                    $estado = $aMercaderia["vese_estado"];
                    //echo $estado;
                }                
                ...
                <tr><td colspan="4">Registrar el porcentaje de venta a Instituciones Públicas por sector o actividad de los clientes. La suma debe ser igual a 100%</td></tr>
                <tr>
                    <td width="40%" rowspan="5" class="titR" >a.  Ventas a Instituciones P&uacute;blicas (Valor aproximado)</td>
                    <td rowspan="5" align="right"  >
                    <input onblur="javascript:saveUPD(1); return false;" type="text" name="input-1" id="input-1" value="<?php  if ($estado > 0){
                        echo number_format($tot2, 0, '.', ',');  } else { echo ('');} ?>" size="12"  maxlength="15" class="inpB2 numeric" />
                    ...
                    <td align="left" class="titR"  >a)  Ministerios e Instituciones P&uacute;blicas del Gobierno Central</td>
                      <td align="center"  >
                        <input onblur="javascript:saveUPD(1); return false;" type="text" name="input-21" id="input-21" value="<?php  if ($estado > 0){ 
                            echo $aMercaderia["vese_valor"];  } else { echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric normalTip" title="En caso que registre venta de mercader&iacute;a o servicios a instituciones p&uacute;blicas, la suma de los porcentajes de venta por sector debe igualar a 100%." />
                      </td>
                </tr>
                <?php 
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input onblur="javascript:saveUPD(1); return false;"  type="text" name="input-22" id="input-22" value="<?php  if ($estado > 0) {
                      echo $aMercaderia["vese_valor"];  } else { echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric normalTip" title="En caso que registre venta de mercader&iacute;a o servicios a instituciones p&uacute;blicas, la suma de los porcentajes de venta por sector debe igualar a 100%." />
                ...
                <tr>
                  <td align="left" class="titR"  >c) Gobiernos Aut&oacute;nomos Municipales</td>
                  <td align="center"  >
                  <input onblur="javascript:saveUPD(1); return false;"  type="text" name="input-23" id="input-23" value="<?php  if ($estado > 0){
                      echo $aMercaderia["vese_valor"]; } else { echo ('');}  ?>" size="20" maxlength="3" class="inpB2 numeric normalTip" title="En caso que registre venta de mercader&iacute;a o servicios a instituciones p&uacute;blicas, la suma de los porcentajes de venta por sector debe igualar a 100%." />
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input onblur="javascript:saveUPD(1); return false;"  type="text" name="input-24" id="input-24" value="<?php  if ($estado > 0) {
                      echo $aMercaderia["vese_valor"]; } else { echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric normalTip" title="En caso que registre venta de mercader&iacute;a o servicios a instituciones p&uacute;blicas, la suma de los porcentajes de venta por sector debe igualar a 100%." />
                ...
                <tr>
                  ...
                  <td align="center"  >
                      ...
                      <span id="percent1" class="labB" ><?php  if ($aMercaderia["vese_estado"] > 0){ echo $percent1; } else { echo ('');} ?></span>
                  </td>
                </tr>
                <?php }                    
                ?>                
                <?php if( $aMercaderia["indent"] == '12' && $aMercaderia["vinieta"] == "a" ) { ?>
                <tr><td colspan="4">Registrar el porcentaje de venta a Empresas Privadas por sector o actividad de los clientes. La suma debe ser igual a 100%</td></tr>
                <tr>
                    <td width="40%" rowspan="5" class="titR" >b.  Ventas a Empresas Privadas (Valor aproximado)</td>
                    <td rowspan="5" align="right"  >
                    <input type="text" name="input-2" id="input-2"  onblur="javascript:saveUPD(1); return false;" value="<?php   if ($estado > 0) {
                        echo number_format($tot3, 0, '.', ','); } else { echo ('');} ?>" size="12" maxlength="15" class="inpB2 numeric">
                    <span class="prefM">Bs</span>
                  ...
                  <td align="center"  >
                    <input onblur="javascript:saveUPD(1); return false;"  type="text" name="input-25" id="input-25" value="<?php   if ($estado > 0) {
                        echo $aMercaderia["vese_valor"];  } else { echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric normalTip" title="En caso que registre venta de mercader&iacute;a o servicios a empresas privadas, la suma de los porcentajes de venta por actividad debe ser igual a 100%." />                    
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input onblur="javascript:saveUPD(1); return false;"  type="text" name="input-26" id="input-26" value="<?php  if ($estado > 0) {
                  echo $aMercaderia["vese_valor"]; } else { echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric normalTip" title="En caso que registre venta de mercader&iacute;a o servicios a empresas privadas, la suma de los porcentajes de venta por actividad debe ser igual a 100%." />
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input onblur="javascript:saveUPD(1); return false;"  type="text" name="input-27" id="input-27" value="<?php  if ($estado > 0) {
                  echo $aMercaderia["vese_valor"];  } else { echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric normalTip" title="En caso que registre venta de mercader&iacute;a o servicios a empresas privadas, la suma de los porcentajes de venta por actividad debe ser igual a 100%." />
                ...
                <tr>
                  <td align="left" class="titR" >d) Otros</td>
                  <td align="center"  >
                  <input onblur="javascript:saveUPD(1); return false;"  type="text" name="input-28" id="input-28" value="<?php  if ($estado > 0) {
                      echo $aMercaderia["vese_valor"]; } else { echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric normalTip" title="En caso que registre venta de mercader&iacute;a o servicios a empresas privadas, la suma de los porcentajes de venta por actividad debe ser igual a 100%." />
                ...
                <tr>
                  ...
                  <td align="right"  >
                      <label class="labB" id="input-3" ><?php  if ($estado > 0) { echo number_format($tot4, 0, '.', ','); } else {echo ('');} ?></label>
                  <span class="prefM">Bs</span>
                ...
                <tr>
                  ...
                  <td align="right"  >                      
                      <label class="labB" id="total2" ><?php  if ($estado > 0) { echo number_format($tot1, 0, '.', ',');  } else {echo ('');} ?></label>
                  </td>
                  <td align="left"  >&nbsp;</td>
                  <td align="right"  >&nbsp;</td>
                </tr>
                <tr>
                  ...
                  <td align="right" >
                      <input   type="text" name="total3" id="total3" value="<?php  if ($estado > 0) {
                          echo number_format($tot5, 0, '.', ',');  } else {echo ('');} ?>" size="12" maxlength="15" class="inpB2 numeric" />
                      <span class="prefM">Bs</span>
                      <span id="div_total3" class="bxEr" style="display:none" >requerido</span>
                  </td>
                  <td align="left"  >&nbsp;</td>
                  <td align="right"  >&nbsp;</td>
                </tr>
                <tr>
                  ...
                  <td align="right" >
                      <input   type="text" name="total4" id="total4" value="<?php  if ($estado > 0) {
                          echo number_format($tot6, 0, '.', ',');  } else {echo ('');}?>" size="12" maxlength="15" class="inpB2 numeric" title="En caso que registre venta de mercader&iacute;a o servicios a empresas privadas, la suma de los porcentajes de venta por actividad debe ser igual a 100%." />
                      <span class="prefM">Bs</span>
                      <span id="div_total3" class="bxEr" style="display:none" >requerido</span>                      
                  </td>
                  <td align="left"  >&nbsp;</td>
            ...
            <p>
                ...
                <span id="msg3" style="display:none;" class="bxEr" >El valor introducido no puede ser mayor que el Total, registrar nuevamente</span>
                <span id="msg4" style="display:none;" class="bxEr" >El valor introducido debe ser menor para llegar al Total que es la suma de a + b + c, registrar nuevamente</span>
                <span id="errore3" style="display:none;" class="bxEr" >Todos los campos son requeridos</span>
            </p>            
