...
<div class="content">
    ...
    <tbody>
        <tr>                        
            <td colspan="2"><b>Contratos a Jornal:</b> Personas contratadas por jornal (por día). Anote abajo el número de hombres y mujeres contratados bajo esta modalidad y el gasto total en jornales, según la categoría ocupacional.</td>
        </tr>
    </tbody>
    </table>            
    <form class="formA validable" action="acap2dAdd.php" method="post" autocomplete="off" >
      <fieldset>
            <table width="100%" class="fOpt" >
                <thead>
                <tr>
                  <th align="center">2.4 PERSONAL POR JORNAL</th>
                ...
                <tr>
                    ...
                    <td width="12%" align="right" ><span class="labB" id="tot1" ><?php if ($estado > 0){ echo number_format($aDat["pejo_menoract_hombres"]);} else {echo ('');} ?></span></td>
                    <td width="12%" align="right" ><span class="labB" id="tot2" ><?php if ($estado > 0){echo number_format($aDat["pejo_menoract_mujeres"]);} else {echo ('');} ?></span></td>
                    <td width="12%" align="right" ><span class="labB" id="tot3" ><?php if ($estado > 0){ echo number_format($aDat["pejo_menoract_valor"]);} else {echo ('');} ?></span></td>
                    <td width="12%" align="right" ><span class="labB" id="tot4" ><?php if ($estado > 0){ echo number_format($aDat["pejo_mayoract_hombres"]);} else {echo ('');} ?></span></td>
                    <td width="12%" align="right" ><span class="labB" id="tot5" ><?php if ($estado > 0){ echo number_format($aDat["pejo_mayoract_mujeres"]);} else {echo ('');} ?></span></td>
                    <td width="12%" align="right" ><span class="labB" id="tot6" ><?php if ($estado > 0){ echo number_format($aDat["pejo_mayoract_valor"]);} else {echo ('');} ?></span></td>
                  </tr>                
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A1" id="A1" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_menoract_hombres"]);} else {echo ('');} ?>" size="8" maxlength="4" class="inpB2 numeric" /></td>
                  <td align="right"><input type="text" name="B1" id="B1" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_menoract_mujeres"]);} else {echo ('');} ?>" size="8" maxlength="4" class="inpB2 numeric" /></td>
                  <td align="right"><input type="text" name="C1" id="C1" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_menoract_valor"]);} else {echo ('');} ?>" size="10" maxlength="11" class="inpB2 numeric" /></td>
                  <td align="right"><input type="text" name="D1" id="D1" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_mayoract_hombres"]);} else {echo ('');} ?>" size="8" maxlength="4" class="inpB2 numeric" /></td>
                  <td align="right"><input type="text" name="E1" id="E1" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_mayoract_mujeres"]);} else {echo ('');} ?>" size="8" maxlength="4" class="inpB2 numeric" /></td>
                  <td align="right"><input type="text" name="F1" id="F1" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_mayoract_valor"]);} else {echo ('');} ?>" size="10" maxlength="11" class="inpB2 numeric" onblur="saveUPD(1);" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A2" id="A2" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_menoract_hombres"]);} else {echo ('');} ?>" size="8" maxlength="4" class="inpB2 numeric" /></td>
                  <td align="right"><input type="text" name="B2" id="B2" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_menoract_mujeres"]);} else {echo ('');} ?>" size="8" maxlength="4" class="inpB2 numeric" /></td>
                  <td align="right"><input type="text" name="C2" id="C2" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_menoract_valor"]);} else {echo ('');} ?>" size="10" maxlength="11" class="inpB2 numeric" /></td>
                  <td align="right"><input type="text" name="D2" id="D2" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_mayoract_hombres"]);} else {echo ('');} ?>" size="8" maxlength="4" class="inpB2 numeric" /></td>
                  <td align="right"><input type="text" name="E2" id="E2" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_mayoract_mujeres"]);} else {echo ('');} ?>" size="8" maxlength="4" class="inpB2 numeric" /></td>
                  <td align="right"><input type="text" name="F2" id="F2" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_mayoract_valor"]);} else {echo ('');} ?>" size="10" maxlength="11" class="inpB2 numeric" onblur="saveUPD(1);" /></td>
                </tr>                              
                <?php } ?>
                ...
                <tr>
                    ...
                    <td align="right"><input type="text" name="A3" id="A3" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_menoract_hombres"]);} else {echo ('');} ?>" size="8" maxlength="4" class="inpB2 numeric" /></td>
                    <td align="right"><input type="text" name="B3" id="B3" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_menoract_mujeres"]);} else {echo ('');} ?>" size="8" maxlength="4" class="inpB2 numeric" /></td>
                    <td align="right"><input type="text" name="C3" id="C3" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_menoract_valor"]);} else {echo ('');} ?>" size="10" maxlength="11" class="inpB2 numeric" /></td>
                    <td align="right"><input type="text" name="D3" id="D3" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_mayoract_hombres"]);} else {echo ('');} ?>" size="8" maxlength="4" class="inpB2 numeric" /></td>
                    <td align="right"><input type="text" name="E3" id="E3" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_mayoract_mujeres"]);} else {echo ('');} ?>" size="8" maxlength="4" class="inpB2 numeric" /></td>
                    <td align="right"><input type="text" name="F3" id="F3" value="<?php if ($estado > 0){ echo number_format($aDat["pejo_mayoract_valor"]);} else {echo ('');} ?>" size="10" maxlength="11" class="inpB2 numeric" onblur="saveUPD(1);" /></td>
                </tr>
                <?php } ?>
