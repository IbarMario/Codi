        ...
        <table width="100%" class="fOpt" >
            <thead>
                ...
                while( $aDat = $db->next_record() ) {
                    $estado = $aDat["otin_estado"];
                ?>                
                <?php if( $aDat["subcap"] == '1' ) { ?>
                <tr>
                    <td width="71%" class="titR" >1. Combustibles y lubricantes</td>
                    <td width="29%" align="right" ><input type="text" name="A1" id="A1" value="<?php if ($estado > 0){ echo number_format($aDat["otin_inventarioinicial"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                    <td width="29%" align="right" ><input type="text" name="B1" id="B1" value="<?php if ($estado > 0){ echo number_format($aDat["otin_inventariofinal"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                  </tr>                
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A2" id="A2" value="<?php if ($estado > 0){ echo number_format($aDat["otin_inventarioinicial"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                  <td align="right"><input type="text" name="B2" id="B2" value="<?php if ($estado > 0){ echo number_format($aDat["otin_inventariofinal"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A3" id="A3" value="<?php if ($estado > 0){ echo number_format($aDat["otin_inventarioinicial"]);} else {echo ('');} ?>" onblur="javascript:saveUPD(1); return false;" size="20" maxlength="14" class="inpB2 numeric" /></td>
                  <td align="right"><input type="text" name="B3" id="B3" value="<?php if ($estado > 0){ echo number_format($aDat["otin_inventariofinal"]);} else {echo ('');} ?>" onblur="javascript:saveUPD(1); return false;" size="20" maxlength="14" class="inpB2 numeric" /></td>
                </tr>                
                <?php 
                ...
                <tr id="otrosingresos" <?php echo $showrow; ?>  >
                  <td class="titR" ><input type="text" name="A5" id="A5" value="<?php if ($estado > 0){ echo $aDat["otin_description"];} else {echo ('');} ?>" size="50" class="inpC2" /></td>
                ...
                <tr>
                    ...
                    <td align="right">                    
                    <span id="tot1" class="labB"><?php if ($estado > 0){ echo number_format($aDat["otin_inventarioinicial"]);} else {echo ('');} ?></span>
                    </td>
                    <td align="right"><span id="tot2" class="labB"><?php if ($estado > 0){ echo number_format($aDat["otin_inventariofinal"]);} else {echo ('');} ?></span></td>
                </tr>
                <?php } ?>                                                                                                                                                              
                <?php } ?>
                </tbody>
