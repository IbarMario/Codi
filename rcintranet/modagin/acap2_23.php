      ...
      <fieldset>    
            <table width="100%" class="fOpt" >
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="C2" onblur="javascript:saveUPD(2); return false;" id="C2" value="<?php if ($estado > 0){ echo $aSueldos["pesu_sueldos_salarios"];} else {echo ('');} ?>" size="20" class="inpB2 numeric" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="C3" onblur="javascript:saveUPD(3); return false;" id="C3" value="<?php if ($aSueldos["pesu_estado"] > 0){ echo $aSueldos["pesu_sueldos_salarios"];} else {echo ('');} ?>" size="20" class="inpB2 numeric" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="C4" onblur="javascript:saveUPD(4); return false;" id="C4" value="<?php if ($estado > 0){ echo $aSueldos["pesu_sueldos_salarios"];} else {echo ('');} ?>" size="20" class="inpB2 numericDec" /></td>
                </tr>                
                <?php } ?>
                ...
                <tr>
                    ...
                    <td align="right"><input type="text" name="C5" id="C5" onblur="javascript:saveUPD(5); return false;" value="<?php if ($estado > 0){ echo $aSueldos["pesu_sueldos_salarios"];} else {echo ('');} ?>" size="20" class="inpB2 numeric">
                ...
                <tr>
                    ...
                    <td align="right"><input type="text" name="perS" id="perS" onblur="javascript:saveUPD(5); return false;" value="<?php if ($estado > 0){ echo $aSueldos["pesu_sueldos_salarios"];} else {echo ('');} ?>" size="20" class="inpB2 numeric">
                        <span id="div_peventual" class="bxEr" style="display:none" >requerido</span>
                        <span id="div_peventual_2" class="bxEr" style="display:none" >inválido</span>
                    </td>                    
                </tr>
