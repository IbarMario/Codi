        ...
        <table width="100%" class="fOpt" >
            <thead>
                ...
                while( $aDat = $db->next_record() ) {
                    $estado = $aDat["merc_estado"];
                ?>                
                <?php if( $aDat["subcap"] == '1' ) { ?>
                <tr>
                    <td width="71%" class="titR" >1. Venta de mercader&iacute;as sin transformaci&oacute;n (V)</td>
                    <td width="29%" align="right" ><input type="text" name="A1" id="A1" value="<?php  if ($estado > 0){ echo number_format($aDat["merc_valor"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                  </tr>                
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A2" id="A2" value="<?php if ($estado > 0){ echo number_format($aDat["merc_valor"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A3" id="A3" onblur="javascript:saveUPD(1); return false;" value="<?php  if ($estado > 0){ echo number_format($aDat["merc_valor"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A4" id="A4" value="<?php  if ($estado > 0){ echo number_format($aDat["merc_valor"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right">
                      <span id="costo1" class="labB"><?php  if ($estado > 0){ echo number_format($aDat["merc_valor"]);} else {echo ('');} ?></span>                      
                  </td>
                </tr>                
                <?php } ?>
                ...
                <tr>
                    ...
                    <td align="right">                                        
                    <span id="costo2" class="labB"><?php if ($estado > 0){ echo number_format($aDat["merc_valor"]);} else {echo ('');} ?></span>
                    </td>
                </tr>
                <?php } ?>                                
