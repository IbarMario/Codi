            ...
            <table width="100%" class="fOpt" >
                ...
                <tr>
                  <td class="titR" >1.1 Obreros</td>
                    <td width="20%" align="right" ><label class="labB" id="A1"><?php echo number_format($aSueldos["pesu_numero_hombres"]) ?></label></td>
                    <td width="20%" align="right" ><label class="labB" id="B1"><?php echo number_format($aSueldos["pesu_numero_mujeres"]) ?></label></td>
                    <td width="20%" align="right" ><label class="labB" id="C1"><?php echo number_format($aSueldos["pesu_sueldos_salarios"]) ?></label></td>
                 <!---                    
                ...
                <tr>
                    ...
                    <td align="right"><input type="text" name="B5" id="B5" value="<?php echo $aSueldos["pesu_numero_mujeres"] ?>" maxlength="5" size="20" class="inpB2 numeric">
                        ...
                        <span id="div_peventualM_2" class="bxEr" style="display:none" >inv�lido</span>
                    </td>
                    <td align="right"><input type="text" name="C5" id="C5" onblur="javascript:saveUPD(5); return false;" value="<?php echo $aSueldos["pesu_sueldos_salarios"] ?>" size="20" class="inpB2 numeric">
                        ...
                        <span id="div_peventual_2" class="bxEr" style="display:none" >inv�lido</span>
                    </td>
                </tr>
                <?php } ?>
                ...
                <tr>
                    ...
                    <td align="right"><input type="text" name="perH" id="perH" value="<?php echo $aSueldos["pesu_numero_hombres"] ?>" maxlength="5" size="20" class="inpB2 numeric">
                        <span id="div_peventualH" class="bxEr" style="display:none" >requerido</span>
                        <span id="div_peventualH_2" class="bxEr" style="display:none" >inv�lido</span>
                    </td>
                    <td align="right"><input type="text" name="perM" id="perM" value="<?php echo $aSueldos["pesu_numero_mujeres"] ?>" maxlength="5" size="20" class="inpB2 numeric">
                        <span id="div_peventualM" class="bxEr" style="display:none" >requerido</span>
                        <span id="div_peventualM_2" class="bxEr" style="display:none" >inv�lido</span>
                    </td>
                    <td align="right"><input type="text" name="perS" id="perS" onblur="javascript:saveUPD(5); return false;" value="<?php echo $aSueldos["pesu_sueldos_salarios"] ?>" size="20" class="inpB2 numeric">
                        <span id="div_peventual" class="bxEr" style="display:none" >requerido</span>
                        <span id="div_peventual_2" class="bxEr" style="display:none" >inv�lido</span>
                    </td>
                    <!-----
                ...
                <tr>
                    ...
                    <span id="div_nopagH_2" class="bxEr" style="display:none" >inv�lido</span>
                    </td>
                    ...
                    <span id="div_nopagM_2" class="bxEr" style="display:none" >inv�lido</span>
                    </td>
                    <td align="right"></td>
                </tr>
                <?php } ?>
