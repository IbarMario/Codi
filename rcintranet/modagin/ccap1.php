...
<fieldset>
    ...
    <p>
        <span class="subT">6. &iquest;Cu&aacute;l es el tipo de conexi&oacute;n a Internet utilizado?  (responda esta pregunta, s&oacute;lo si respondi&oacute; afirmativamente a la pregunta 5)</span>
        <span class="clear"></span>
    </p>
    <p>
    ...
    <?php } ?>
     ...
     <p>
        <span class="subT">7. &iquest;Cu&aacute;l es el Ancho de Banda con el que cuenta la empresa para conectarse a internet?  (responda esta pregunta, s&oacute;lo si respondi&oacute; afirmativamente a la pregunta 5)</span>
        <span class="clear"></span>
     </p>
     <p>
