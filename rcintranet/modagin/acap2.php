...
<div class="content">
    ...
    <tbody>
        ...
        <tr>
        <td colspan="2"><b>Paso 1.-</b> Registre el Total Parcial en la Columna de Hombres. y presione la tecla Tab. (Tabulador)  <br>
                    <b>Paso 2.-</b> Registre la cantidad de Personal Eventual, y presionar tab, los valores de Personal permenente se calculan automáticamente.<br>
                    <b>Paso 3.-</b> Registre la cantidad de Gerentes y/o personal directivo y presionar Tab., los subtotales se calculan automaticamente<br>                
                    <b>Paso 4.-</b> Registre la cantidad de Personal Administrativo y Ventas y presionar Tab., los subtotales se calculan automaticamente<br>     
                    <b>Paso 5.-</b> Registre la cantidad de Supervisores, jefes de planta y/o producción y presionar Tab., los subtotales se calculan automaticamente<br>
                    <b>Paso 6.-</b> Continuar bajo esta metodología para la columna que corresponde a Mujeres y Sueldos y Salarios.<br>
                    <b>Paso 7.-</b> Registre la fila que corresponde a personal de Apoyo.<br>
     </tr>
    </tbody>
    </table>                                   
      ...
      <fieldset>    
            <table width="100%" class="fOpt" >
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="C4" onblur="javascript:saveUPD(4); return false;" id="C4" value="<?php if ($estado > 0){ echo $aSueldos["pesu_sueldos_salarios"];} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numericDec" /></td>
                </tr>                
                <?php } ?>
