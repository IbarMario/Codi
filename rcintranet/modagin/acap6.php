...
?>
    ...
    <tbody>
        <tr>                        
          ...
          <tr>                        
            <td colspan="2">Paso 1.- Introducir el monto correspondiente al TOTAL VENTAS, Total Ventas al Mercado Nacional se calcula automaticamente y presionar Tab.<br>
            Paso 2.- Introducir el monto que corresponde a Total Ventas a Mercado Externo, 1.1 Total Ventas al Mercado Nacional y se calcula automaticamente al igual que c. Venta a Personas Particulares, presiona Tab<br>
            Paso 3.- Introducir el monto b. Ventas a Empresas Privadas, 1.1 Total Ventas al Mercado Nacional y se calcula automaticamente al igual que c. Venta a Personas Particulares presiona Tab.<br>
            Paso 4.- Introducir el monto a. Ventas a Instituciones Públicas, 1.1 Total Ventas al Mercado Nacional y se calcula automaticamente al igual que c. Venta a Personas Particulares presiona Tab.<br>            
        </tr>
    </tbody>
    </table>
        ...
        <fieldset>
          ...
          <table width="100%" class="fOpt"  >
                ...
                while( $aVP = $db->next_record() ) {
                    if( $aVP["vepr_defi_uid"]==383 ) { $tot1 = $aVP["vepr_valor"]; } //Ventas a Instituciones P�blicas
                ...
                <tr>
                    ...
                    <input  type="text" name="input-1" id="input-1" value="<?php if ($estado > 0){ echo number_format($tot1); } else {echo ('');} ?>" size="20" class="inpB2 numeric" />
                    ...
                    <td align="left" class="titR"  >a) Ministerios e Instituciones P&uacute;blicas del Gobierno Central</td>
                      <td align="center"  >
                        <input  type="text" name="input-21" id="input-21" value="<?php if ($estado > 0){ echo $aVP["vepr_valor"]; } else {echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric" />
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input   type="text" name="input-22" id="input-22" value="<?php if ($estado > 0){  echo $aVP["vepr_valor"]; } else {echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric" />
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input   type="text" name="input-23" id="input-23" value="<?php if ($estado > 0){ echo $aVP["vepr_valor"]; } else {echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric" />
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input   type="text" name="input-24" id="input-24" onblur="javascript:saveUPD(1); return false;" value="<?php if ($estado > 0){ echo $aVP["vepr_valor"]; } else {echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric" />
                ...
                <tr>
                  ...
                  <td align="center"  >
                      ...
                      <span id="percent1" class="labB" ><?php  if ($estado > 0){echo $percent1;} else {echo ('');} ?></span>
                  </td>
                </tr>
                <?php }                    
                ?>
                ...
                <tr>
                    ...
                    <input   type="text" name="input-2" id="input-2" value="<?php if ($estado > 0){ echo number_format($tot2);} else {echo ('');} ?>" size="20" class="inpB2 numeric">
                  ...
                  <td align="center"  >
                    <input   type="text" name="input-25" id="input-25" value="<?php if ($estado > 0){  echo $aVP["vepr_valor"]; } else {echo ('');}?>" size="20" maxlength="3" class="inpB2 numeric" />
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input   type="text" name="input-26" id="input-26" value="<?php if ($estado > 0){ echo $aVP["vepr_valor"];} else {echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric" />
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input   type="text" name="input-27" id="input-27" value="<?php if ($estado > 0){ echo $aVP["vepr_valor"];} else {echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric" />
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input   type="text" name="input-28" id="input-28" onblur="javascript:saveUPD(1); return false;" value="<?php if ($estado > 0){ echo $aVP["vepr_valor"];} else {echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric" />
                ...
                <tr>
                  ...
                  <td align="center"  ><input type="text" name="input-29" id="input-29" onblur="javascript:saveUPD(2); return false;" value="<?php if ($estado > 0){ echo $aVP["vepr_valor"];} else {echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric" /></td>
                </tr>
                <?php 
                    $percent2 = $percent2 + $aVP["vepr_valor"];
                } ?>
                ...
                <tr>
                  ...
                  <td align="center"  ><input   type="text" name="input-30" id="input-30" value="<?php if ($estado > 0){ echo $aVP["vepr_valor"];} else {echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric" /></td>
                </tr>
                <?php 
                    $percent2 = $percent2 + $aVP["vepr_valor"];
                } ?>
                ...
                <tr>
                  ...
                  <td align="center"  ><input   type="text" name="input-31" id="input-31" onblur="javascript:saveUPD(1); return false;" value="<?php if ($estado > 0){  echo $aVP["vepr_valor"];} else {echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric" /></td>
                </tr>
                <tr>
                  <td align="left" class="titR" >Total %</td>
                  <td align="center"  >
                      <?php $percent2 = $percent2 + $aVP["vepr_valor"]; ?>
                      <span id="percent2" class="labB" ><?php  if ($estado > 0){ echo $percent2;} else {echo ('');} ?></span>
                  </td>
                </tr>
                <?php 
                    $percent2 = $percent2 + $aVP["vepr_valor"];
                ...
                <tr>
                  ...
                  <label class="labB" id="input-3" ><?php if ($estado > 0){ echo number_format($tot3, 2, '.', ',');} else {echo ('');} ?></label>                  
                  <span id="div_input-3" class="bxEr" style="display:none" >requerido</span>
                  </td>
                  
                  <!---                  
                  <td rowspan="3" align="right"  >
                  <input type="text" name="input-3" id="input-3" value="<?php if ($estado > 0){echo number_format($tot3);} else {echo ('');} ?>" size="20" class="inpB2 numeric" />
                  <span id="div_input-3" class="bxEr" style="display:none" >requerido</span>                  </td>                  
                  -->
                  
                  <td align="left" class="titR"  > a) Comerciantes</td>
                  <td align="right"  ><input   type="text" name="input-32" id="input-32" value="<?php if ($estado > 0){ echo $aVP["vepr_valor"];} else {echo ('');}?>" size="20" maxlength="3" class="inpB2 numeric" /></td>
                </tr>
                <?php 
                ...
                <tr>
                  ...
                  <td align="right"  ><input   type="text" name="input-33" id="input-33" onblur="javascript:saveUPD(3); return false;" value="<?php if ($estado > 0){ echo $aVP["vepr_valor"];} else {echo ('');} ?>" size="20" maxlength="3" class="inpB2 numeric" /></td>
                </tr>
                                                
                <tr>
                  <td align="left" class="titR"  >Total %</td>
                  <td align="right"  ><?php $percent3 = $percent3 + $aVP["vepr_valor"]; ?>
                  <span id="percent3" class="labB" ><?php  if ($estado > 0){echo $percent3;} else {echo ('');} ?></span></td>
                </tr>
                <?php                     
                } ?>                
                <?php 
                ...
                <tr>
                  ...
                  <td align="right">
                       <label class="labB" id="totventanl" ><?php if ($estado > 0){ echo number_format($tot4, 2, '.', ','); } else {echo ('');}?></label>                      
                  </td>
                  <!---
                  <td align="right"  ><span class="labB" id="totventanal" ><?php if ($estado > 0){ echo number_format($tot4);} else {echo ('');} ?></span></td>
                  -->
                  <td align="left"  >&nbsp;</td>
                  <td align="right"  >&nbsp;</td>
                </tr>
                <tr>
                  ...
                  <td align="right"  ><input type="text" name="totexterno" id="totexterno" value="<?php if ($estado > 0){ echo number_format($tot5);} else {echo ('');} ?>" size="20"  maxlength="14" class="inpB2 numeric" /></td>
                  <td align="left"  >&nbsp;</td>
                  <td align="right"  >&nbsp;</td>
                </tr>
                <tr>
                  ...
                  <td align="right"  >                    
                        <input type="text" name="totventa" id="totventa" value="<?php  if ($estado > 0) { echo number_format($tot6, 2, '.', ',');} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" title="En caso que registre venta de mercader&iacute;a o servicios a empresas privadas, la suma de los porcentajes de venta por actividad debe ser igual a 100%." />
                  </td>
                  <td align="left"  >&nbsp;</td>
                  <td align="right"  >&nbsp;</td>                  
                  <!--
                  <td align="right"  ><span class="labB" id="totventa" ><?php if ($estado > 0){ echo number_format($tot6);} else {echo ('');} ?></span></td>
                  -->
                </tr>
                </tbody>
            </table>
