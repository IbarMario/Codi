        ...
        <table width="100%" class="fOpt" >
            <thead>
                ...
                <tr>
                    ...
                    <td align="right"><label class="labB" id="perH"><?php if ($estado > 0){ echo number_format($aSueldos["mapi_valor"]);} else {echo ('');} ?></label></td>
                  </tr>                
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A1" id="A1" value="<?php if ($estado > 0){ echo number_format($aSueldos["mapi_valor"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A2" id="A2" value="<?php  if ($estado > 0){ echo number_format($aSueldos["mapi_valor"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                </tr>
                <?php } ?>                                                                
