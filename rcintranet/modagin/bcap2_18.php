...
cuenta, en la siguiente tabla y pase a la pregunta 2)</p>
         <p><span class="clear"></span> <input  <?php if (OPERATOR::getDbValue("SELECT sige_valor FROM frm3_bcap2_sistemagestion WHERE sige_regi_uid ='".$_SESSION[SITE]["registro_uid"]."' AND  sige_defi_uid ='575'")==1){ echo "checked=\"checked\""; };  ?> name="575" id="575_si" value="1" class="chk" type="radio" >
             <label class="labChk">Si</label>   <span class="clear"></span>   
             <input  <?php if (OPERATOR::getDbValue("SELECT  sige_valor  FROM  frm3_bcap2_sistemagestion  WHERE  sige_regi_uid ='".$_SESSION[SITE]["registro_uid"]."' AND  sige_defi_uid ='575'")==2){ echo "checked=\"checked\""; };  ?> name="575" id="575_no" value="2" class="chk" type="radio" >
             <label class="labChk">No</label></p>
                      ...
                      <table class="fOpt">
                        ...
                        <tr>                        
                          ...
                          <tr>                        
                              ...
                              <td><input type="text" size="16" class="inpB2 validar" name="597" id="B_6" value="<?php echo OPERATOR::getDbValue("SELECT  sige_valor  FROM  frm3_bcap2_sistemagestion  WHERE  sige_regi_uid ='".$_SESSION[SITE]["registro_uid"]."' AND  sige_defi_uid ='597'"); ?>"/></td>
                              <td><input type="text" size="16" class="inpB2 validar" name="598" id="C_6" value="<?php echo OPERATOR::getDbValue("SELECT  sige_valor  FROM  frm3_bcap2_sistemagestion  WHERE  sige_regi_uid ='".$_SESSION[SITE]["registro_uid"]."' AND  sige_defi_uid ='598'"); ?>"/></td>
                          </tr>
                             <tr>                        
