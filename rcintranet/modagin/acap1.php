...
<span id="statusACAP1"></span>
    ...
    <form class="formA validable" action="acap1Add.php" method="post" autocomplete="off" >
        <fieldset>
            <p>
              ...
              <input type="text" name="ai_rs" id="ai_rs" disabled="disabled" value="<?php echo $aInfoGen["inge_razonsocial"] ?>"  size="60" class="inpC alphanum">              
                ...
                <span class="clear"></span>                            
                    ...
                    while ($aSocietario = $db->next_record()) {
                        ...
                        <?php if ($aInfoGen["inge_tiso_uid"] == $aSocietario["tiso_uid"]) {?>
                          <input type="text" name="ai_societario" id="ai_tiso"  disabled="disabled"  value="<?php echo $aSocietario["tiso_description"] ?>" size="60" class="inpC alphanum"   >                          
                        <?php    
                        }  } ?>
            ...
            <p>
                ...
                <span class="clear"></span>               
                <input type="text" name="ai_tradename"  disabled="disabled"  id="ai_tradename" value="<?php echo $aInfoGen["inge_nombrecomercial"] ?>" size="60" class="inpC alphanum">
        ...
        <table class="fOpt">
            ...
            <tbody> 
              <tr>   <!--                     
                  ...
                  ?></td> -->
                  <td>  
                      <input type="text" disabled="disabled" name="ai_address" value="<?php echo $aInfoGen["inge_calle"] ?>" size="40" class="inpC alphanum normalTip" title="Registre el nombre de la calle, avenida, pasaje, etc. de ubicación de su empresa. En caso que se encuentre en carretera o camino, señale el nombre de la carretera o camino y el kilómetro de ubicación. Por ejemplo: carretera a Cotoca, km 8." id="ai_address">
                  </td>
                  <td>
                      <input type="text" disabled="disabled" name="ai_numerocalle" id="ai_numerocalle" onblur="javascript:saveUPD(3); return false;" value="<?php echo $aInfoGen["inge_numcalle"] ?>" size="40" class="inpC alphanum normalTip" title="Registre el número de dirección de su empresa. En caso que no tenga número anote SN. "  /> 
                  </td>
                  <td>
                    <input type="text" name="ai_zona" disabled="disabled" id="ai_zona" value="<?php echo $aInfoGen["inge_zona"] ?>" size="40" class="inpC alphanum normalTip" title="Registre el nombre de la zona o barrio de ubicación de su empresa." />                    
                </td>
            </tr>
        </tbody>
    </table>
 ...
 <!-------------------------------------------------------------------------------------->
    <p>
        ...
        <span class="clear"></span>                  
        <input type="text" name="ai_phone1" id="ai_phone1" disabled="disabled" value="<?php echo $aInfoGen["inge_telefono"] ?>" size="40" class="inpC alphanum">        
    </p>
    <p>
        <span class="subT">9. Celular (Representante legal o prop.):</span>
        <span class="clear"></span>                 
        <input type="text" name="ai_phone2" id="ai_phone2" disabled="disabled" value="<?php echo $aInfoGen["inge_celular"] ?>" size="40" class="inpC alphanum">        
    </p>
    <p>
        <span class="subT">10. Fax:</span>
        <span class="clear"></span>                  
        <input type="text" name="ai_fax" id="ai_fax" disabled="disabled" value="<?php echo $aInfoGen["inge_fax"] ?>" size="40" class="inpC">
        
    </p>
    <p>
        <span class="subT">11. P&aacute;gina Web:</span>
        <span class="clear"></span>                  
        <input type="text" name="ai_pagweb" id="ai_pagweb" disabled="disabled" value="<?php echo $aInfoGen["inge_pagweb"] ?>" size="40" class="inpC alphanum">
    ...
    <input type="text" name="ai_email" id="ai_email" disabled="disabled"  value="<?php echo $aInfoGen["inge_email"] ?>" size="40" class="inpC ">        
            ...
            <!-- end add -->
            <p>
                <span class="subT">14. Afiliaci&oacute;n de la empresa:</span>(especificar)
                <span class="clear"></span>   
            ...
            <p>
                ...
                <span class="clear"></span>               
                <input type="text" name="ai_actprin"  disabled="disabled" id="ai_actprin" value="<?php echo $aInfoGen["inge_actividad_principal"] ?>" size="100" class="inpC alphanum">
