$(document).ready( function() {                
    $("#addcertificacion").click( function( event ){
        ...
        myrow = myrow + '<td width="6%" ><input type="text" name="C_'+nextrow+'" id="C_'+nextrow+'" size="13" maxlength="14" class="inpB2 numeric" onblur="sumcol(\'C\','+nextrow+'); "  ></td>';
        myrow = myrow + '<td width="8%" ><input type="text" name="D_'+nextrow+'" id="D_'+nextrow+'" size="13" maxlength="14" class="inpB2 numeric" onblur="sumcol(\'D\','+nextrow+'); " ></td>';
        myrow = myrow + '<td width="8%" ><input type="text" name="E_'+nextrow+'" id="E_'+nextrow+'" size="13" maxlength="14"  class="inpB2 numeric" onblur="sumcol(\'E\','+nextrow+'); " ></td>';
        myrow = myrow + '<td width="8%" ><input type="text" name="F_'+nextrow+'" id="F_'+nextrow+'" size="13" maxlength="14"  class="inpB2 numeric" onblur="sumcol(\'F\','+nextrow+'); " ></td>';
        myrow = myrow + '<td width="8%" ><label class="labB" id="G_'+nextrow+'" >0</label></td>';
        myrow = myrow + '<td width="8%" ><input type="text" name="H_'+nextrow+'" id="H_'+nextrow+'" size="13" maxlength="14"  class="inpB2 numeric" onblur="sumcol(\'H\','+nextrow+'); " ></td>';
        myrow = myrow + '<td width="8%" ><input type="text" name="I_'+nextrow+'" id="I_'+nextrow+'" size="13" maxlength="14" class="inpB2 numeric" onblur="sumcol(\'I\','+nextrow+'); " ></td>';
        myrow = myrow + '<td width="8%" ><input type="text" name="J_'+nextrow+'" id="J_'+nextrow+'" size="13" maxlength="14"  class="inpB2 numeric" onblur="sumcol(\'J\','+nextrow+');  saveUPD(1); return false;" ></td>';
