$(document).ready( function() {                
    $("#addcertificacion").click( function( event ){
        ...
        myrow = myrow + '<td width="8%" ><input type="text" name="C_'+nextrow+'" id="C_'+nextrow+'" size="12" maxlength="14"  class="inpB2 numeric" onblur="sumcol(\'C\','+nextrow+'); " /></td>';
        myrow = myrow + '<td width="8%" ><input type="text" name="D_'+nextrow+'" id="D_'+nextrow+'" size="12" maxlength="14"  class="inpB2 numeric" onblur="sumcol(\'D\','+nextrow+'); " /></td>';
        myrow = myrow + '<td width="8%" ><input type="text" name="E_'+nextrow+'" id="E_'+nextrow+'" size="12" maxlength="14"  class="inpB2 numeric" onblur="sumcol(\'E\','+nextrow+'); " /></td>';
        myrow = myrow + '<td width="8%" ><input type="text" name="F_'+nextrow+'" id="F_'+nextrow+'" size="12" maxlength="14"  class="inpB2 numeric" onblur="sumcol(\'F\','+nextrow+'); " /></td>';
        myrow = myrow + '<td width="8%" ><input type="text" name="G_'+nextrow+'" id="G_'+nextrow+'" size="12" maxlength="14"  class="inpB2 numeric" onblur="sumcol(\'G\','+nextrow+'); " /></td>';
        myrow = myrow + '<td width="8%" ><input type="text" name="H_'+nextrow+'" id="H_'+nextrow+'" size="12" maxlength="14"  class="inpB2 numeric" onblur="sumcol(\'H\','+nextrow+'); saveUPD(1); return false;"></td>';
