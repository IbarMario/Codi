...
<head>
    ...
    <title>Formulario de Encuesta Industria Manufacturera</title>
...
switch ( $namefile ) {
    ...
    case "acap15a3.php": $pagina=23; break;      
    case "bcap1.php": $pagina=24; break;
    case "bcap2.php": $pagina=25; break;
    case "bcap3.php": $pagina=26; break;
    case "ccap1.php": $pagina=27; break;
    case "dcap1a1.php": $pagina=28; break;
    case "dcap1a2.php": $pagina=29; break;
    case "dcap1a3.php": $pagina=30; break;
    case "dcap1a4.php": $pagina=31; break;
    case "dcap1e.php": $pagina=32; break;
    case "dcap2.php": $pagina=33; break;
    default: $pagina = ""; break;
}
$title1 = "ENCUESTA ANUAL DE UNIDADES PRODUCTIVAS<br />INDUSTRIA MANUFACTURERA <br />";
// SE PUSO EL AÑO MANUALMENTE DEBE SER AUTOMÁTICO LA GESTION QUE LE CORRESPONDE
$gestion1 = "gesti&oacute;n 2014";
...
<div id="wrpB">    
    <div class="header">    
        ...
        -->        
         <div class="bxTit">
            ENCUESTA ANUAL DE UNIDADES PRODUCTIVAS<br/> INDUSTRIA  MANUFACTURERA<br />
        ...
        <div class="infUP">
            ...
            <?php if( !empty($pagina) ){ ?>
            <div class="pag">
                <span>P&aacute;gina</span><span class="color3"><?php echo $pagina; ?></span><span>de</span><span>33</span>
            </div>
            <?php } ?>
        </div>        
