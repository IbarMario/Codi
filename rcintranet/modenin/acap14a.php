    ...
    <form class="formA validable" action="acap14a1Add.php" method="post" autocomplete="off" >
      <fieldset>                          
          ...
          <table width="100%" class="fOpt" id="tablecertificacion" >
                <thead>
                <tr>
                  <td rowspan="2" align="center" >DESCRIPCI&Oacute;N DE MATERIAS PRIMAS, MAGTERIALES AUXILIARES, ENVASES Y EMBALAJES</td>
                ...
                while( $aCert2 = $db3->next_record() ) {
                    ...
                    //////CAMBIOS DE COLUMNA PORUQE NO RECUPERA LO QUE TIENE QUE RECUPERAR
                ...
                <tr id="row_<?php echo $pos; ?>" >
                    ...
                    <td width="8%" ><input type="text" name="H_<?php echo $pos ?>" id="H_<?php echo $pos ?>" value="<?php echo number_format($aCert2["mapr_util_cantidad"]) ?>"   size="11" maxlength="14"  class="inpB2 numeric" onblur="sumcol('H',<?php echo $pos ?>);" /></td>
                    <td width="8%" ><input type="text" name="I_<?php echo $pos ?>" id="I_<?php echo $pos ?>" value="<?php echo number_format($aCert2["mapr_util_valor"]) ?>"      size="11"  maxlength="14" class="inpB2 numeric" onblur="sumcol('I',<?php echo $pos ?>); saveUPD(1); return false;" /></td>
