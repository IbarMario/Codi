              ...
              <thead>
               ...
               <?php if( $aSuministro["vinieta"] == 1 ) { ?>
                <tr>
                    ...
                    <input type="text" name="input-1" id="input-1" text="Registre el monto pagado por Energía Eléctrica al año" value="<?php if ($estado > 0){ echo $aSuministro["sumi_valor"];} else {echo ('');} ?>" size="20" maxlength="11"  class="inpB2 numeric" >
                    <span id="div_input-1" class="inpB" style="display:none" >requerido</span>
                    <span id="div_input-1_2" class="inpB" style="display:none" >inv�lido</span>
                    </td>
                    ...
                    <span id="div_input-11_2" class="inpB" style="display:none" >inv�lido</span>
                    </td>
                ...
                <tr>
                    ...
                    <td align="right"  ><input type="text" name="input-2" id="input-2"  text="Registre el monto pagado por consumo de agua al año"  value="<?php if ($estado > 0){ echo $aSuministro["sumi_valor"];} else {echo ('');} ?>" size="20"  maxlength="11" class="inpB2 numeric">
                    <span id="div_input-2" class="inpB" style="display:none" >requerido</span>
                    <span id="div_input-2_2" class="inpB" style="display:none" >inv�lido</span>
                    </td>
                    <td align="center">                    
                    <?php
                        $sqlTarifa = "SELECT cata_descripcion FROM par_categorias_tarifarias ORDER BY cata_descripcion ASC ";
                    ...
                    <span id="div_input-12_2" class="inpB" style="display:none" >inv�lido</span>
                    </td>
                ...
                <tr>
                    ...
                    <td align="right"  ><input type="text" name="input-3" id="input-3" value="<?php if ($estado > 0){ echo $aSuministro["sumi_valor"];} else {echo ('');} ?>" size="20"  maxlength="11" class="inpB2 numeric"  text="Registre el monto pagado por consumo de Gas Natural al año" >
                    <span id="div_input-3" class="inpB" style="display:none" >requerido</span>
                    <span id="div_input-3_2" class="inpB" style="display:none" >inv�lido</span>
                    </td>
                    <td align="center"  >                                               
                    <?php
                        $sqlTarifa = "SELECT cata_descripcion FROM par_categorias_tarifarias ORDER BY cata_descripcion ASC ";
                    ...
                    <span id="div_input-13_2" class="inpB" style="display:none" >inv�lido</span>
                    </td>
                ...
                <tr>
                    ...
                    <td align="right"  >
                    <input type="text" name="input-4" id="input-4" value="<?php if ($estado > 0){ echo $aSuministro["sumi_valor"];} else {echo ('');} ?>" size="20"  maxlength="11" class="inpB2 numeric"  text="Registre el monto pagado por Diesel oil al año">
                    <span id="div_input-4" class="inpB" style="display:none" >requerido</span>
                    <span id="div_input-4_2" class="inpB" style="display:none" >inv�lido</span>
                    </td>
                    <td  >&nbsp;</td>
                    <td  >&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="right"  >
                    <input type="text" name="input-5" id="input-5" onblur="javascript:saveUPD(4); return false;"  value="<?php if ($estado > 0){ echo $aSuministro["sumi_valor"] ;} else {echo ('');} ?>" size="20"  maxlength="11" class="inpB2 numeric"  text="Registre el monto pagado por Gasolina al año" >
                    <span id="div_input-5" class="inpB" style="display:none" >requerido</span>
                    <span id="div_input-5_2" class="inpB" style="display:none" >inv�lido</span>
                    </td>
                    <td  >&nbsp;</td>
                    <td  >&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="right">
                    <input type="text" name="input-6" id="input-6" value="<?php if ($estado > 0){ echo $aSuministro["sumi_valor"] ;} else {echo ('');} ?>" size="20"  maxlength="11" class="inpB2 numeric"  text="Registre el monto pagado por consumo de Gas Licuado al año">
                    <span id="div_input-6" class="inpB" style="display:none" >requerido</span>
                    <span id="div_input-6_2" class="inpB" style="display:none" >inv�lido</span>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="right">
                    <input type="text" name="input-10" id="input-10" value="<?php if ($estado > 0){ echo $aSuministro["sumi_valor"];} else {echo ('');} ?>" size="20" maxlength="11"  class="inpB2 numeric" text="Registre el monto pagado por Gas Natural Vehicular al año" >
                ...
                <tr>
                    ...
                    <td align="right" >
                    <input type="text" name="input-8" id="input-8" value="<?php if ($estado > 0){ echo $aSuministro["sumi_valor"];} else {echo ('');} ?>" size="20" maxlength="11" class="inpB2 numeric"  text="Registre el monto pagado por Otros combustibles y lubricantes al año">
                    <span id="div_input-8" class="inpB" style="display:none" >requerido</span>
                    <span id="div_input-8_2" class="inpB" style="display:none" >inv�lido</span>
                    </td>
                    <td>&nbsp;</td>
                    <td> 
                    <?php 
                    ...
                    ?>
                    <input type="text" name="input-9" id="input-9" onblur="javascript:saveUPD(5); return false;" value="<?php if ($estado > 0){ echo $aSuministro["sumi_categoriatarifaria"];} else {echo ('');} ?>" <?php echo $mostrar; ?>  size="30" class="inpC2">                    
                    <span id="div_input-9_2" class="inpB" style="display:none" >inv�lido</span>
                    </td>
                ...
                <tr>
                  ...
                  <td align="right"><label class="labB" id="ai_totsuministros"  ><?php if ($estado > 0){ echo number_format($aSuministro["sumi_valor"]);} else {echo ('');}  ?></label></td>
                  <td></td>
                  <td></td>
                </tr>
                <?php } ?>
