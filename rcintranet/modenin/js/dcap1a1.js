...
$("#sendData").click( function (e){
    ...
    $("#addrow_a").click( function( event ){                                        
        ...
        myrow = myrow + '<td width="13%"><input type="text" name="A_'+nextrow+'" id="A_'+nextrow+'" size="40" class="inpC2 identAvalide" /></td>';
    ...
    $("#addrow_b").click( function( event ){                                        
        ...
        myrow = myrow + '<td width="13%"><input type="text" name="A2_'+nextrow+'" id="A2_'+nextrow+'" size="40" class="inpC2 identBvalide"  /></td>';
    ...
    $("#addrow_c").click( function( event ){                                       
        ...
        myrow = myrow + '<td width="13%"><input type="text" name="A3_'+nextrow+'" id="A3_'+nextrow+'" size="40" class="inpC2 identCvalide" /></td>';
...
function check(id, el, e){
    var res = true;
if ($("#A"+el+"_"+id).val()=="") { if ($("#B"+el+"_"+id).val()!="") { var res = false; }; if ($("#C"+el+"_"+id).val()!="") { var res = false; };};
if ($("#B"+el+"_"+id).val()=="") { if ($("#C"+el+"_"+id).val()!="") { var res = false; }; if ($("#B"+el+"_"+id).val()!="") { var res = false; };};
if ($("#C"+el+"_"+id).val()=="") { if ($("#A"+el+"_"+id).val()!="") { var res = false; }; if ($("#A"+el+"_"+id).val()!="") { var res = false; };};
if (res) {
return true;
}else{
$("#msg").show();
