...
<div class="content">
    ...
    <tr>
        <th>MODULO D</th>
        <th>SERVICIOS TECNOL&Oacute;GICOS Y CAPACITACI&Oacute;N GESTI&Oacute;N</th>
    </tr>
    </thead>    
    </table>        
    <table class="dInf">
      ...
      <fieldset>    
          ...
          <table width="100%" class="fOpt" id="table_a" >
                ...
                <tr id="rowa_<?php echo $pos; ?>" >
                    <td width="13%"><input type="text" name="A_<?php echo $pos ?>" id="A_<?php echo $pos ?>" value="<?php echo $aDat["capa_descripcion"] ?>"   size="40" class="inpC2 identAvalide" /></td>
                ...
                <tr id="rowa_<?php echo $posmax; ?>" >
                    <td width="13%"><input type="text" name="A_<?php echo $posmax; ?>" id="A_<?php echo $posmax; ?>" size="40" class="inpC2 identAvalide" /></td>
            ...
            <p>
                ...
                <span id="msg2" style="display: none;" class="bxEr" >DEBE INTRODUCIR EL DETALLE DEL EVENTO</span>               
            </p>
...
<!-- table 1 --> 
          ...
          <table width="100%" class="fOpt" id="table_b" >
                ...
                <tr id="rowb_<?php echo $pos; ?>" >
                    <td width="13%"><input type="text" name="A2_<?php echo $pos ?>" id="A2_<?php echo $pos ?>" value="<?php echo $aDat["capa_descripcion"] ?>"   size="40" class="inpC2 identBvalide" /></td>
                ...
                <tr id="rowb_<?php echo $posmax; ?>" >
                    <td width="13%"><input type="text" name="A2_<?php echo $posmax; ?>" id="A2_<?php echo $posmax; ?>" size="40" class="inpC2 identBvalide" /></td>
        ...
        <tbody>
                ...
                <tr id="rowc_<?php echo $pos; ?>" >
                    <td width="13%"><input type="text" name="A3_<?php echo $pos ?>" id="A3_<?php echo $pos ?>" value="<?php echo $aDat["capa_descripcion"] ?>"   size="40" class="inpC2 identCvalide" /></td>
                ...
                <tr id="rowc_<?php echo $posmax; ?>" >
                    <td width="13%"><input type="text" name="A3_<?php echo $posmax; ?>" id="A3_<?php echo $posmax; ?>" size="40" class="inpC2 identCvalide" /></td>
        ...
        <a href="#" id="addrow_c" class="btnAdd">Agregar campos</a>
              ...
              <p>
                <span id="msg" style="display: none;" class="bxEr" >Debe llenar todos los campos.</span>           
            </p>
