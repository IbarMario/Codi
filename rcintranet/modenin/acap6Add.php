...
//Ventas a Instituciones P�blicas (Valor aproximado)
...
$in3 = OPERATOR::toSql(safeHTML(OPERATOR::getParam("totventa")),'Text');
$dato[137] = preg_replace('/,/', '', $in3);

// Total Ventas al Mercado Nacional (Valor aproximado) (a + b + c)
//$dato[138] = $dato[158] + $dato[159] + $dato[151];
$dato[138] = $dato[137] - $dato[143];

//ventas a personas perticulares valor aproximado
...
$dato[151] = $dato[138] - $dato[158] - $dato[159];
