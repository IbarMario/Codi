      ...
      <fieldset>                          
          ...
          <table width="100%" class="fOpt" id="tablecertificacion" >
                ...
                <tr>
                  ...
                  <td align="right"  ></td>
                  <td align="right"  ><label class="labB" id="totTK"><?php echo number_format($aTot["util_valor"]) ?></label></td>
                  <td align="right"  ></td>
                  <td align="right"  ><label class="labB" id="totTI"><?php echo number_format($aTot["invfin_valor"]) ?></label></td>                  
                  <td align="right"  >&nbsp;</td>
                </tr>
                </tfoot>                
            </table>
