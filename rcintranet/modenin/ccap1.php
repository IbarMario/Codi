...
<fieldset>
    ...
    <p>
        ...
        <input type="text" name="nrolineas" id="nrolineas" value="<?php if ($estado > 0){  echo number_format($aDat["usac_cantidad1"]);} else {echo ('');} ?>" class="numeric inpC" />
    </p>
    <?php } ?>
    ...
    <p>
        ...
        <span class="clear"></span>
        <input type="text" name="nrocelular" id="nrocelular" value="<?php if ($estado > 0){  echo number_format($aDat["usac_cantidad1"]);} else {echo ('');} ?>" class="numeric inpC" />
    </p>
    <?php } ?>
    ...
    <p>
        <span class="subT">3. &iquest;Cu&aacute;ntos computadores propios y/o alquilados tiene la empresa?</span>
        <span class="clear"></span>
        <input type="text" name="nro_pcs" id="nro_pcs" value="<?php  if ($estado > 0){ echo number_format($aDat["usac_cantidad1"]);} else {echo ('');} ?>" class="numeric inpC" />
    </p>        
    <?php } ?>

    <?php if( $aDat["subcap"] == 5 &&  $aDat["vinieta"] == '1' ) { ?>
    <p>
        <span class="subT">4. &iquest;La empresa cuenta con Internet?</span>
        <span class="clear"></span>
    ...
    <p>
        <span class="subT">5. &iquest;La empresa cuenta con Intranet?</span>
        <span class="clear"></span>
    ...
    <p>
        <span class="subT">6. &iquest;Cu&aacute;l es el tipo de conexi&oacute;n a Internet utilizado?  (responda esta pregunta, s&oacute;lo si respondi&oacute; afirmativamente a la pregunta 4)</span>
        <span class="clear"></span>
    </p>
    <p>
    ...
    <?php } ?>
     ...
     <div class="areainter" <?php echo $showareainter; ?> > <!-- ini areainter -->
     <p>
        <span class="subT">7. &iquest;Cu&aacute;l es el Ancho de Banda con el que cuenta la empresa para conectarse a internet?  (responda esta pregunta, s&oacute;lo si respondi&oacute; afirmativamente a la pregunta 4)</span>
        <span class="clear"></span>
     </p>
     <p>
    ...
    <tr>             
        <td class="titR" >8. &iquest;Del personal de la empresa, cu&aacute;ntos utilizan computadoras en su rutina normal de trabajo?</td>          
        <td align="center"><input name="admA_1" type="text" id="admA_1" size="8" value="<?php  if ($estado > 0){echo number_format($aDat["usac_cantidad1"]);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputA-1" class="bxEr" style="display:none" >requerido</span></td>
        <td align="center"><input name="admB_1" type="text" id="admB_1" size="8" value="<?php  if ($estado > 0){echo number_format($aDat["usac_cantidad2"]);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputB-1" class="bxEr" style="display:none" >requerido</span></td>
    </tr>
    <?php } ?>

    <?php if( $aDat["subcap"] == 10 &&  $aDat["vinieta"] == '1' ) { ?> 
    <tr>
        <td class="titR">9.  &iquest;Del personal de la empresa, cu&aacute;ntos utilizan computadoras conectadas a Internet en su rutina normal de trabajo?</td>        
        <td align="center"><input name="admA_2" type="text" id="admA_2" size="8" value="<?php  if ($estado > 0){echo number_format($aDat["usac_cantidad1"]);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputA-2" class="bxEr" style="display:none" >requerido</span></td>
        <td align="center"><input name="admB_2" type="text" id="admB_2" size="8" value="<?php  if ($estado > 0){echo number_format($aDat["usac_cantidad2"]);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputB-2" class="bxEr" style="display:none" >requerido</span></td>
    </tr>
    <?php } ?>

    <?php if( $aDat["subcap"] == 11 &&  $aDat["vinieta"] == '1' ) { ?> 
    <tr>
        <td class="titR">10.  &iquest;Del personal de la empresa, cu&aacute;ntos tienen asignada una cuenta de correo electr&oacute;nico con nombre de dominio de la empresa?</td>        
        <td align="center"><input name="admA_3" type="text" id="admA_3" size="8" value="<?php  if ($estado > 0){echo number_format($aDat["usac_cantidad1"]);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputA-3" class="bxEr" style="display:none" >requerido</span></td>
        <td align="center"><input name="admB_3" type="text" id="admB_3" size="8" value="<?php  if ($estado > 0){echo number_format($aDat["usac_cantidad2"]);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputB-3" class="bxEr" style="display:none" >requerido</span></td>
    </tr>
    <?php } ?>
    ...
    <p>
        <span class="subT">11. &iquest;El personal (administrativo, ejecutivo) o el propietario, utiliza internet para el desarrollo de las actividades de la empresa?</span>
        <span class="clear"></span>
    ...
    <p>
        <span class="subT">12.  &iquest;Para cu&aacute;l de las siguientes actividades, el personal o el propietario de la empresa, utiliza internet? (Se acepta respuesta m&uacute;ltiple)</span>
        <span class="clear"></span>
    ...
    <p>
        <span class="subT">13. &iquest;La empresa tiene SITIO WEB?</span>
        <span class="clear"></span>
    ...
    <span class="subT">14. La empresa utiliza alg&uacute;n(os) programa(s) o paquete(s) de software para realizar:</span>
    <table width="100%"  class="fOpt" >
    <thead>
        <tr>
            <th width="23%">&nbsp;</th>
    ...
    <tbody>
        <tr>       
            ...
            <td align="center"><input name="C_1" type="text" id="C_1" size="8" value="<?php if ($estado > 0){ echo number_format($cantNal_1);} else {echo ('');}  ?>" class="numeric inpB2" /><span id="div_inputA-1" class="bxEr" style="display:none" >requerido</span></td>
            <td align="center"><input name="D_1" type="text" id="D_1" onblur="saveUPD(1);" size="8" value="<?php  if ($estado > 0){echo number_format($cantImport_1);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputB-1" class="bxEr" style="display:none" >requerido</span></td>
        ...
        <tr>
            ...
            <td align="center"><input name="C_2" type="text" id="C_2" size="8" value="<?php  if ($estado > 0){echo number_format($cantNal_2);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputA-2" class="bxEr" style="display:none" >requerido</span></td>
            <td align="center"><input name="D_2" type="text" id="D_2"  size="8" value="<?php  if ($estado > 0){echo number_format($cantImport_2);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputB-2" class="bxEr" style="display:none" >requerido</span></td>
        ...
        <tr>
            ...
            <td align="center"><input name="C_3" type="text" id="C_3" size="8" value="<?php  if ($estado > 0){echo number_format($cantNal_3);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputA-3" class="bxEr" style="display:none" >requerido</span></td>
            <td align="center"><input name="D_3" type="text" id="D_3" onblur="saveUPD(1);" size="8" value="<?php  if ($estado > 0){echo number_format($cantImport_3);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputB-3" class="bxEr" style="display:none" >requerido</span></td>
        ...
        <tr>
            ...
            <td align="center"><input name="C_4" type="text" id="C_4" size="8" value="<?php  if ($estado > 0){echo number_format($cantNal_4);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputA-4" class="bxEr" style="display:none" >requerido</span></td>
            <td align="center"><input name="D_4" type="text" id="D_4" size="8" value="<?php  if ($estado > 0){echo number_format($cantImport_4);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputB-4" class="bxEr" style="display:none" >requerido</span></td>
        ...
        <tr>
            ...
            <td align="center"><input name="C_5" type="text" id="C_5" size="8" value="<?php if ($estado > 0){ echo number_format($cantNal_5);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputA-5" class="bxEr" style="display:none" >requerido</span></td>
            <td align="center"><input name="D_5" type="text" id="D_5" onblur="saveUPD(1);" size="8" value="<?php if ($estado > 0){ echo number_format($cantImport_5);} else {echo ('');} ?>" class="numeric inpB2" /><span id="div_inputB-5" class="bxEr" style="display:none" >requerido</span></td>
        ...
        <tr>
            ...
            <td align="center"><input name="C_6" type="text" id="C_6" size="8" value="<?php  if ($estado > 0){echo number_format($cantNal_6);} else {echo ('');} ?>" class="numeric inpB2" /></td>
            <td align="center"><input name="D_6" type="text" id="D_6" size="8" value="<?php  if ($estado > 0){echo number_format($cantImport_6);} else {echo ('');} ?>" class="numeric inpB2" /></td>
