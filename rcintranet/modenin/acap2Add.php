...
$hom[91] = $hom[90] -  $hom[92] -  $hom[93]- $hom[94];
...
$muj[91] = $muj[90] -  $muj[92] -  $muj[93]- $muj[94];
...
$sala[91] = $sala[90] - $sala[92] - $sala[93]- $sala[94];

$c6 = OPERATOR::toSql(safeHTML(OPERATOR::getParam("C6")),'Text');
$sala[97] = preg_replace('/,/', '', $c6);
