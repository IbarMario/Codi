    ...
    <form class="formA validable" action="acap2bAdd.php" method="post" autocomplete="off" >
      <fieldset>   
            <table width="100%" class="fOpt" >
                <thead>
                <tr>
                    <th align="center">2.2 OTROS PAGOS AL PERSONAL (NO INCLUYE APORTES PATRONALES)</th>
                ...
                while( $aSueldos = $db->next_record() ) {
                    $estado = $aSueldos["otpa_estado"];
                    //echo $estado;
                ?>                
                <?php if( $aSueldos["indent"] == '1' ) { ?>
                <tr>
                    <td width="71%" class="titR" >1. Aguinaldo</td>
                    <td width="29%" align="right" ><input type="text" name="A1" id="A1" value="<?php  if ($estado > 0){ echo number_format($aSueldos["otpa_valor"]);} else {echo ('');}  ?>" size="20" maxlength="11" class="inpB2 numeric" title="Registre el monto que se pagó por concepto de aguinaldos" /></td>
                  </tr>                
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A2" id="A2" value="<?php if ($estado > 0){  echo number_format($aSueldos["otpa_valor"]);} else {echo ('');}  ?>" size="20" maxlength="11" class="inpB2 numeric"  title="Registre el monto que se pagó en Especies" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A3" id="A3" value="<?php  if ($estado > 0){ echo number_format($aSueldos["otpa_valor"]);} else {echo ('');}  ?>" size="20" maxlength="11" class="inpB2 numeric" onblur="javascript:saveUPD(1); return false;"  title="Registre el monto que se pagó por concepto de Idemnizaciones o Beneficios Sociales" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A4" id="A4" value="<?php  if ($estado > 0){ echo number_format($aSueldos["otpa_valor"]);} else {echo ('');}  ?>" size="20" maxlength="11" class="inpB2 numeric"  title="Registre el monto que se pagó por concepto Bonos de Proucción" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A5" id="A5" value="<?php if ($estado > 0){  echo number_format($aSueldos["otpa_valor"]);} else {echo ('');}  ?>" maxlength="11" size="20" class="inpB2 numeric" title="Registre el monto que se pagó por concepto de Horas Extras" /></td>
                </tr>                
                <?php } ?>
                ...
                <tr>
                    ...
                    <input type="text" name="A6" id="A6" value="<?php  if ($estado > 0){ echo number_format($aSueldos["otpa_valor"]);} else {echo ('');} ?>" maxlength="11" size="20" class="inpB2 numeric" onblur="javascript:saveUPD(2); return false;"  title="Registre el monto que se pagó por otro concepto no incorporado en estos puntos" /></td>
                </tr>
                <?php
                ...
                <tr id="otrosdetalle" <?php echo $show1 ?> >
                    <td class="titR" ><input type="text" name="A7" id="A7" value="<?php  if ($estado > 0){ echo $aSueldos["otpa_descripcion"];} else {echo ('');}  ?>" size="60" class="inpC2" /></td>
                    <td align="right"></td>
                </tr>
                <?php } ?>                
                ...
                <tr>
                    ...
                    <td align="right"><label class="labB" id="perH"><?php  if ($estado > 0){ echo number_format($aSueldos["otpa_valor"]);} else {echo ('');}  ?></label></td>
                </tr>
                <?php } ?>                                              
                <?php } ?>
                </tbody>
