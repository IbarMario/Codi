...
if( !empty($regisroUID) && !empty($uidFormulario) ) {
    ...
    if( $db2->numrows() >  0 ) {
        ...
        while( $aCert = $db2->next_record()  ) {
            ...
            if( $aCert["mapr_delete"] != 1 ) {
                ...
                $sql .= "mapr_invfin_cantidad	 = '".$colH."', ";
                $sql .= "mapr_invfin_valor	 = '".$colI."', ";
                $sql .= "mapr_util_cantidad	 = '".$colJ."', ";      
                $sql .= "mapr_util_valor	 = '".$colK."', ";                      
    ...
    if( $db->numrows() > 0 ) {
        ...
        $sql .= "mapr_invfin_cantidad	  = '".$h."', ";
        $sql .= "mapr_invfin_valor	     = '".$ci."', ";
        $sql .= "mapr_util_cantidad	= '".$j."', ";      
        $sql .= "mapr_util_valor	   = '".$k."', ";                       
        $sql .= "mapr_suv_uid = '".$uid_token."', ";
        $sql .= "mapr_updatedate = NOW() ";
