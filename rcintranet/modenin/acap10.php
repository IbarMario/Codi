      ...
      <fieldset>
        ...
        <table width="100%" class="fOpt" >
                ...
                while( $aDat = $db->next_record() ) {
                    $estado = $aDat["rege_estado"];
                ?>                
                <?php if( $aDat["subcap"] == '1' ) { ?>
                <tr>
                    <td width="71%" class="titR" >1. Utilidad neta de la gesti&oacute;n</td>
                    <td width="29%" align="right" ><input type="text" name="A1" id="A1" value="<?php if ($estado > 0){  echo number_format($aDat["rege_valor"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                  </tr>                
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A2" id="A2" value="<?php if ($estado > 0){  echo number_format($aDat["rege_valor"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                  </tr>
                <?php } ?>                                                                             
