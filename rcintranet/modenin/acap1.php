...
<span id="statusACAP1"></span>
        ...
        <fieldset>
            ...
            <p>
             ...
             <p>
                ...
                <span class="clear"></span>             
                <input type="text" disabled="disabled" name="ai_ciiu" id="ai_ciiu"  value="<?php echo $aInfoGen["inge_ciiu"] ?>"  size="20" class="inpC alphanum">
            ...
            <p>
                ...
                <span class="clear"></span>                
                <input type="text" name="ai_nit" disabled="disabled" id="ai_nit" value="<?php echo $aInfoGen["inge_nit"] ?>" size="50" class="inpC " maxlength="12">                
            </p>           
            <p>
                <span class="subT">5. N&uacute;mero de Matr&iacute;cula de Comercio:</span>
                <span class="clear"></span>                
                <input type="text" disabled="disabled" name="ai_traderegis" id="ai_traderegis" value="<?php echo $aInfoGen["inge_matriculadecomercio"] ?>" size="50" class="inpC integer" maxlength="8" >                
            </p>                        
            <p>
                <span class="subT">6. RAI - Registro Ambiental Industrial:</span>
                <span class="clear"></span>                
                <input type="text" name="ai_rai" id="ai_rai" value="<?php echo $aInfoGen["inge_rai"] ?>" size="50" class="inpC required" maxlength="50" >
         ...
         <p>
            ...
            <p>
                ...
                <span class="clear"></span>                                
                <input type="text" disabled="disabled" name="ai_depto" id="ai_depto" value="<?php echo $aInfoGen["inge_nombre_departamento"] ?>" size="50" class="inpC alphanum" maxlength="8" >                
            </p>
            <p>
                <span class="subT">Provincia:</span>
                <span class="clear"></span>                 
                <span id="areaprovincia" >
                <input type="text" disabled="disabled" name="ai_provin" id="ai_provin" value="<?php echo $aInfoGen["inge_nombre_provincia"] ?>" size="50" class="inpC alphanum" maxlength="8" >
                </span>                                
            </p>       
            <p>
                ...
                <input type="text" disabled="disabled" name="ai_municipio" id="ai_municipio" value="<?php echo $aInfoGen["inge_nombre_municipio"] ?>" size="50" class="inpC alphanum" maxlength="8" >     
              </span>                              
          </p>
          <p>
            <span class="subT">Ciudad:</span>
            <span class="clear"></span>                
            <input type="text" name="ai_city" disabled="disabled" id="ai_city" value="<?php echo $aInfoGen["inge_ciudad"] ?>" size="50" class="inpC alphanum" >            
          </p>
          <p>
        ...
        <table class="fOpt">
            ...
            <tbody> 
              <tr>   <!--                     
                  ...
                  ?></td> -->
                  <td>  
                      <input type="text" disabled="disabled" name="ai_address" value="<?php echo $aInfoGen["inge_calle"] ?>" size="50" class="inpC alphanum normalTip" title="Registre el nombre de la calle, avenida, pasaje, etc. de ubicación de su empresa. En caso que se encuentre en carretera o camino, señale el nombre de la carretera o camino y el kilómetro de ubicación. Por ejemplo: carretera a Cotoca, km 8." id="ai_address">
                  </td>
                  <td>
                      <input type="text" disabled="disabled" name="ai_numerocalle" id="ai_numerocalle" onblur="javascript:saveUPD(3); return false;" value="<?php echo $aInfoGen["inge_numcalle"] ?>" size="50" class="inpC alphanum normalTip" title="Registre el número de dirección de su empresa. En caso que no tenga número anote SN. "  /> 
                  </td>
                  <td>
                    <input type="text" name="ai_zona" disabled="disabled" id="ai_zona" value="<?php echo $aInfoGen["inge_zona"] ?>" size="50" class="inpC alphanum normalTip" title="Registre el nombre de la zona o barrio de ubicación de su empresa." />                    
                </td>
            </tr>
        </tbody>
    </table>
 ...
 <!-------------------------------------------------------------------------------------->
    <p>
        ...
        <span class="clear"></span>                  
        <input type="text" name="ai_phone1" id="ai_phone1" disabled="disabled" value="<?php echo $aInfoGen["inge_telefono"] ?>" size="50" class="inpC">        
    </p>
    <p>
        <span class="subT">9. Celular (Representante legal o prop.):</span>
        <span class="clear"></span>                 
        <input type="text" name="ai_phone2" id="ai_phone2" disabled="disabled" value="<?php echo $aInfoGen["inge_celular"] ?>" size="50" class="inpC">        
    </p>
    <p>
        <span class="subT">10. Fax:</span>
        <span class="clear"></span>                  
        <input type="text" name="ai_fax" id="ai_fax" disabled="disabled" value="<?php echo $aInfoGen["inge_fax"] ?>" size="50" class="inpC">
        
    </p>
    <p>
        <span class="subT">11. P&aacute;gina Web:</span>
        <span class="clear"></span>                  
        <input type="text" name="ai_pagweb" id="ai_pagweb" disabled="disabled" value="<?php echo $aInfoGen["inge_pagweb"] ?>" size="50" class="inpC alphanum">
        
    </p>
    <p>
    <span class="subT">12. Correo electr&oacute;nico:</span>
    <span class="clear"></span>                 
    <input type="text" name="ai_email" id="ai_email" disabled="disabled"  value="<?php echo $aInfoGen["inge_email"] ?>" size="50" class="inpC ">        
    </p>                     
            <!-- add -->
            ...
            <tr id="row_<?php echo $pos; ?>" >
              ...
              <td align="center"><input name="inputB_<?php echo $pos ?>" type="text" id="inputB_<?php echo $pos ?>" size="50" value="<?php echo $aCert2["plan_municipio"] ?>" onblur="saveUPD(6);" class="inpC2" /></td>              
            ...
            <tr id="row_<?php echo $posmax; ?>" >
              ...
              <td align="center"><input name="inputB_<?php echo $posmax; ?>" type="text" id="inputB_<?php echo $posmax; ?>" size="50" class="inpC2" onblur="saveUPD(6);"  /></td>              
              <td align="center">&nbsp;</td>
            </tr>    
            <?php 
            $posmax = $posmax + 1;
            ...
            <p>
                ...
                <input type="text" class="inpC" size="50"  name="afil_camara" id="afil_camara"  value="<?php echo $aInfoGen["inge_afiliacion_camara"] ?>"  <?php echo $show1;  ?>   />
                <span class="clear"></span>
                ...
                <input type="text" class="inpC" size="50" name="afil_federacion" id="afil_federacion"  value="<?php echo $aInfoGen["inge_afiliacion_federacion"] ?>"  <?php echo $show2;  ?>  />
                <span class="clear"></span>
                ...
                <input type="text" class="inpC" size="50" name="afil_asociacion"  id="afil_asociacion" value="<?php echo $aInfoGen["inge_afiliacion_asociacion"] ?>"  <?php echo $show2;  ?>  />
                <span class="clear"></span>
                ...
                <input type="text" class="inpC" size="50" name="afil_sindicato" id="afil_sindicato" value="<?php echo $aInfoGen["inge_afiliacion_sindicato"] ?>" <?php echo $show4;  ?>  >
                <span class="clear"></span>                
                ...
                <input type="text" class="inpC" size="50" name="afil_otros" id="afil_otros"  value="<?php echo $aInfoGen["inge_afiliacion_otros"] ?>"  <?php echo $show3;  ?>  >
                <span class="clear"></span>
            ...
            <p>
                ...
                <span class="clear"></span>               
                <input type="text" name="ai_actprin"  disabled="disabled" id="ai_actprin" value="<?php echo $aInfoGen["inge_actividad_principal"] ?>" size="100" class="inpC alphanum required">
        ...
        <span class="clear"></span>                  
        <input type="text" name="ai_actsec1" id="ai_actsec1"  disabled="disabled" value="<?php echo $aInfoGen["inge_actividad_secundaria1"] ?>" size="100" class="inpC alphanum">
        <span id="div_ai_actprin" class="bxEr" style="display:none" >requerido</span>
        <span id="div_ai_actprin_2" class="bxEr" style="display:none" >inválido</span>
            </p>            
            <p>
                ...
                <span class="clear"></span>                 
                <input type="text" name="ai_actsec2" id="ai_actsec2"  disabled="disabled"  value="<?php echo $aInfoGen["inge_actividad_secundaria2"] ?>" size="100" class="inpC alphanum">
