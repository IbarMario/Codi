        ...
        <table width="100%" class="fOpt" >
            <thead>
                ...
                while( $aSueldos = $db->next_record() ) {
                    $estado = $aSueldos["inop_valor"]
                ?>                
                <?php if( $aSueldos["subcap"] == '1' ) { ?>
                <tr>
                    <td width="71%" class="titR" >1. Ingresos por alquileres (excepto terrenos)</td>
                    <td width="29%" align="right" ><input type="text" name="A1" id="A1" value="<?php if ($estado > 0){  echo number_format($aSueldos["inop_valor"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                  </tr>                
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A2" id="A2" value="<?php  if ($estado > 0){ echo number_format($aSueldos["inop_valor"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A3" id="A3" onblur="javascript:saveUPD(1); return false;" value="<?php if ($estado > 0){ echo number_format($aSueldos["inop_valor"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td align="right"><input type="text" name="A4" id="A4" value="<?php  if ($estado > 0){ echo number_format($aSueldos["inop_valor"]);} else {echo ('');} ?>" size="20" maxlength="14" class="inpB2 numeric" /></td>
                </tr>
                <?php 
                ...
                <tr>
                    ...
                    <td align="right">                    
                    <span id="costo1" class="labB"><?php   if ($estado > 0){echo number_format($aSueldos["inop_valor"]);} else {echo ('');} ?></span>
                    </td>
                </tr>
                <?php } ?>                                                                                                                
