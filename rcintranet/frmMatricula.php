...
<div align="center" id="wrpB">    
  ...
  <div class="contH">       
        <div class="bxCnt"><br/>
            ...
            <h3>Este módulo permite introducir los datos de un formulario de Encuesta previamente llenado.<br/></h3>            
    </div>
    <div  class="contC">            
<h2>Busqueda del Formulario</h2>
            <p>
            Ingrese el Número de Matrícula y de identificación de la Boleta para la búsqueda:</p>
            <p><br />
            </p>            
