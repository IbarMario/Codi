...
<div align="center" id="wrpB">    
  ...
  <div class="contH">       
        <div class="bxCnt"><br/>
            ...
            <h3>Este módulo permite ELIMINAR los datos de un formulario de la Encuesta previamente llenado.<br/>            
            Antes de realizar este proceso debe obtener un backup de la Base de Datos por seguridad.<br/></h3>
    </div>
    <div  class="contC">            
<h2>Busqueda del Formulario</h2>
  ...
  <form  method="post" action="busca_registro.php" > 
    ...
    <table width="450" border="1" cellspacing="1" cellpadding="1">
        ...
        <?php if ($sw1>0) {echo "<h2>El formulario no esta en la base de datos del Padrón Empresarial</h2>";}; ?>      
        <?php if ($sw1>0) {echo "<h2>El formulario no esta en la base de datos del Padrón Empresarial</h2>";}; ?>      
        ...
        <tr>            
            <td height="38">&nbsp;<label>Número de Identificación de Boleta:</label></td>
            <td><input type="text" id="idboleta" name="idboleta" size="20" class="textbox" title="Ingrese el Número de Identificador de Boleta" class="inpB2 integer"/></td>          
        </tr>
        <tr>            
            <td height="38">&nbsp;<label>Código de usuario Interno:</label></td>
            <td><input type="text" id="idinterno" name="idinterno" size="20" class="textbox" title="Ingrese el Código de Usuario Interno" class="inpB2 integer"/></td>          
        </tr>
        <tr>
