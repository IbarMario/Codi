...
<html>
    ...
    <body>
        ...
        // put your code here
        ?>        
        Elimina un formulario de la base de datos<br><br>
        Antes de realizar este procedimiento debe obtnener un backup de la Base de Datos por seguridad.<br><br>        
        <a href="form_ingreso.php">Inicio</a><br>        
    </body>
</html>
