...
var idUser = '$idusuario';
    ...
    if(empty($_POST['usuario_nombre']) || empty($_POST['usuario_clave'])) {
        ...
        if($row = mysql_fetch_array($sql)) {
            ...
            $sql = mysql_query("INSERT into t_accesos (usuario_acceso, fecha_acceso, tarea_acceso, observ_acceso) values ('$idusuario',now(), 'APROBACION DE BOLETAS DE BOLETAS DE CONSTACIA DE PRESENTACION DE LA ENCUESTAS ANUAL DE UNIDADES PRODUCTIVAS', 'INGRESO');");
            //echo $sql;            
            echo "<script>var idUser = '$idusuario';</script>";            
            echo '<script type="text/javascript">window.location.href="frmVerificacion.php?$iMsXa09="+idUser </script>';
            //echo "dlkfjklasdfjaklsdf";                                   
            //echo "<input type='hidden' name='idusuario' value='hola'/>"; 
            //header("Location: index.php");
            //echo '<script type="text/javascript">window.location.href="frmReporte.php";</script>';
            //echo '<script type="text/javascript">window.location.href="frmVerificacion.php?idusuario=/"'+$idusuario+'/";</script>';
            //echo '<script type="text/javascript">window.location.href="frmVerificacion.php?idusuario="144";</script>';
            //echo '<script type="text/javascript">window.location.href="frmVerificacion.php?idusuario='.$idusuario.';</script>';
