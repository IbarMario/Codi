...
if (isset($_POST["boton"])) {
    $sql_insert = $conn->Execute("UPDATE t_aprobacion SET aprobacion_estado = '1', aprobacion_fecha_aprobacion = NOW(), aprobacion_usuario_id = WHERE id_aprobacion = '$_POST[id]';");
}?>		
    <body>
    <div id="wrpB">    
      <div class="contH">
...
<!-- class="formL validable" -->
    <form class="formL validable" name="form1"  method="post" action="frmfinal.php" >              
            <fieldset>
              <p>
                <label>N&ordm; de matr&iacute;cula:</label>
                <input name="matricula" type="text" class="inpA required normalTip" id="matricula" value="<?php echo $reg_encuesta->fields["aprobacion_nro_matricula"];?>" size="20" readonly="readonly" />
                <input name="nromatricula" type="hidden" id="nromatricula" value="<?php echo $reg_encuesta->fields["aprobacion_nro_matricula"];?>" size="40" readonly="readonly" />
                <input name="id" type="hidden" id="id" value="<?php echo $id;?>" />                
              </p>
              <p>
                <label>N&ordm; de registro:</label>
                <input name="registro" type="text" class="inpA required normalTip" id="registro" value="<?php echo $reg_encuesta->fields["aprobacion_nro_registro"];?>" size="20" readonly="readonly" />
                <input name="nroregistro" type="hidden" id="nroregistro" value="<?php echo $reg_encuesta->fields["aprobacion_nro_registro"];?>" size="40" readonly="readonly" />
              </p>
              <p>
                <label>Código de control:</label>
                  <input name="control" type="text" class="inpA required email normalTip" id="control" value="<?php echo $reg_encuesta->fields["aprobacion_codigo_control"];?>" size="20" readonly="readonly"/>
                  <input name="codcontrol" type="hidden" id="codcontrol" value="<?php echo $reg_encuesta->fields["aprobacion_codigo_control"];?>" size="40" readonly="readonly"/>
              </p>
              <p>
                ...
                <input name="idusuario" type="hidden" id="idusuario" value="<?php echo $usuario_id;?>" size="40" />                
              </p>              
              <p>
              <p>
