          ...
          <table width="100%" class="fOpt" >
                ...
                <tr>
                  <td class="titR" >8.  Otros activos fijos  
                    ...
                    <input type="text" name="input_52" id="input_52" value="<?php if ($estado > 0){ echo result2(8, 1, 'foaf_description');} else {echo ('');}  ?>" <?php echo $mostrar; ?>  size="30" class="inpC2"  onKeyUp="this.value = this.value.toUpperCase();"  pattern="[A-Z ]*"  > 
