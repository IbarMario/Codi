...
<div class="content">
    ...
    <tbody>
        <tr>                        
         ...
         <tr>                        
            <td colspan="2"><b>Paso 1.-</b> Llenar el monto correspondiente al Total, luego debe presionar la tecla Tab.(Tabulador)<br>
                <b>Paso 2.-</b> Llenar el monto correspondiente al Compra de mercadería Extranjera, y se calcula automáticamente la compra de mercadería nacional.<br>
                <b>Paso 3.-</b> Llenar los porcentajes correspondientes, se calcula automaticamente el cien por ciento.
            </td>
        </tr>
    </tbody>
    </table>     
        ...
        <fieldset>          
          <table width="100%" class="fOpt" >
            <thead>
                ...
                $sql = " SELECT core_defi_uid, core_valor, core_estado"
                ...
                while( $aMercaderia = $db->next_record() ) { 
                    ...
                    $estado = $aMercaderia["core_estado"];
                }
                ...
                <?php if( $aMercaderia["indent"] == '1' && $aMercaderia["vinieta"] == "a" ) { ?>
                  <tr><td colspan="4">Registrar el porcentaje de compra de mercadería de fabricación nacional por sector o actividad de los proveedores. La suma debe ser igual a 100%</td></tr>
                <tr>
                    <td width="40%" rowspan="5" class="titR" >1.  Compra de mercader&iacute;a de fabricaci&oacute;n nacional (Valor aproximado)</td>
                    <td rowspan="5" align="right"  >
                        <label class="labB" id="input-1" ><?php  if ($estado > 0){
                            echo number_format($tot1, 0, '.', ','); } else {echo ('');}  ?></label>                                              
                    <span class="prefM">Bs</span>                                                           
                    </td>
                    <td align="left" class="titR" >a)  Agricultura, ganader&iacute;a, caza, silvicultura y pesca</td>
                    <td align="center"  >
                    <input type="text" name="input-21" id="input-21" maxlength="3" value="<?php if ($estado > 0){
                        echo $aMercaderia["core_valor"]; } else {echo ('');}  ?>" size="15" class="inpB2 integer numeric normalTip" title="En caso que registre compra de mercader&iacute;a de fabricaci&oacute;n nacional, la suma de los porcentajes de venta por sector o actividad debe igualar a 100%." />                                                            
                    </td>
                </tr>
                <?php 
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input type="text" name="input-22" id="input-22" maxlength="3" value="<?php if ($estado > 0){
                      echo $aMercaderia["core_valor"];  } else {echo ('');} ?>" size="15" class="inpB2 integer numeric normalTip" title="En caso que registre compra de mercader&iacute;a de fabricaci&oacute;n nacional, la suma de los porcentajes de venta por sector o actividad debe igualar a 100%." /> 
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input type="text" name="input-23"  id="input-23" maxlength="3" value="<?php if ($estado > 0){
                      echo $aMercaderia["core_valor"]; } else {echo ('');}  ?>" size="15" class="inpB2 integer numeric normalTip" title="En caso que registre compra de mercader&iacute;a de fabricaci&oacute;n nacional, la suma de los porcentajes de venta por sector o actividad debe igualar a 100%." />
                ...
                <tr>
                  ...
                  <td align="center"  >
                  <input type="text" name="input-24" onblur="javascript:saveUPD(1); return false;" id="input-24" maxlength="3" value="<?php  if ($estado > 0){
                      echo $aMercaderia["core_valor"]; } else {echo ('');}  ?>" size="15" class="inpB2 integer numeric normalTip" title="En caso que registre compra de mercader&iacute;a de fabricaci&oacute;n nacional, la suma de los porcentajes de venta por sector o actividad debe igualar a 100%." />                   
                ...
                <tr>
                  ...
                  $percent1 = $percent1 + $aMercaderia["core_valor"];
                  ?>
                  <label class="labB" id="percent1"><?php  if ($estado > 0){
                      echo $percent1; } else {echo ('');} ?></label>                  
                  </td>
                </tr>
                <?php } ?>        
                <?php if( $aMercaderia["indent"] == '2' && $aMercaderia["vinieta"] == "a" ) { ?>
                <tr><td colspan="4">Registrar el porcentaje de compra de mercadería de fabricación extranjera por sector o actividad de los proveedores. La suma debe ser igual a 100%</td></tr>
                <tr>
                    <td width="40%" rowspan="5" class="titR" >2.  Compra de mercader&iacute;a de fabricaci&oacute;n <br />
                    extranjera (Valor aproximado)</td>
                    <td rowspan="5" align="right">
                    <input type="text" name="input-2" id="input-2" value="<?php  if ($estado > 0){
                        echo number_format($tot2, 0, '.', ',');  } else {echo ('');} ?>" size="12" maxlength="14" class="inpB2 numeric normalTip" title="En caso que registre compra de mercader&iacute;a de fabricaci&oacute;n extranjera, la suma de los porcentajes de venta por sector o actividad debe igualar a 100%.">
                    <span class="prefM">Bs</span> 
                    ...
                    <td align="left" class="titR"  >a)  Agricultura, ganader&iacute;a, caza, silvicultura y pesca</td>
                    <td align="center"  >
                    <input type="text" name="input-25" id="input-25" maxlength="3" value="<?php  if ($estado > 0){
                        echo $aMercaderia["core_valor"];  } else {echo ('');} ?>" size="15" class="inpB2 integer numeric normalTip" title="En caso que registre compra de mercader&iacute;a de fabricaci&oacute;n extranjera, la suma de los porcentajes de venta por sector o actividad debe igualar a 100%.">                    
                    <!--
                ...
                <tr>
                  <td align="left" class="titR"  >b)  Industria manufacturera</td>
                  <td align="center"  >
                  <input type="text" name="input-26" id="input-26" maxlength="3" value="<?php  if ($estado > 0){
                      echo $aMercaderia["core_valor"]; } else {echo ('');}  ?>" size="15" class="inpB2 integer numeric normalTip" title="En caso que registre compra de mercader&iacute;a de fabricaci&oacute;n extranjera, la suma de los porcentajes de venta por sector o actividad debe igualar a 100%.">
                ...
                <tr>
                  <td align="left" class="titR" >c)  Comercio por mayor</td>
                  <td align="center"  >
                  <input type="text" name="input-27" id="input-27" maxlength="3" value="<?php  if ($estado > 0){ 
                      echo $aMercaderia["core_valor"];  } else {echo ('');} ?>" size="15" class="inpB2 integer numeric normalTip" title="En caso que registre compra de mercader&iacute;a de fabricaci&oacute;n extranjera, la suma de los porcentajes de venta por sector o actividad debe igualar a 100%.">
                ...
                <tr>
                  <td align="left" class="titR" >d) Otros</td>
                  <td align="center"  >
                  <input type="text" name="input-28" onblur="javascript:saveUPD(2); return false;" id="input-28" maxlength="3" value="<?php  if ($estado > 0){
                      echo $aMercaderia["core_valor"]; } else {echo ('');} ?>" size="15" class="inpB2 integer numeric normalTip" title="En caso que registre compra de mercader&iacute;a de fabricaci&oacute;n extranjera, la suma de los porcentajes de venta por sector o actividad debe igualar a 100%.">
                ...
                <tr>
                  ...
                  <td align="center"  >
                      ...
                      <label class="labB" id="percent2"><?php if ($estado > 0){
                          echo $percent2; } else {echo ('');} ?></label>                      
                  </td>
                </tr>
                <?php } ?>
                <?php } //end while ?>                                
                ...
                ?>
                <tr>
                  <td class="titR" >3.  TOTAL DE MERCADER&Iacute;AS COMPRADAS:<br>(Valor de Estados Finanzas)</td>
                  <td align="right"  >                                    
                      <input type="text" name="total" id="total" value="<?php  if ($estado > 0){
                          echo number_format($tot3, 0, '.', ',');  } else {echo ('');} ?>" size="12" maxlength="14" class="inpB2 numeric normalTip" title="En caso que registre compra de mercader&iacute;a de fabricaci&oacute;n nacional, la suma de los porcentajes de venta por sector o actividad debe igualar a 100%." />                       
                     <span class="prefM">Bs</span>                       
                  </td>
                  <td align="left"  >&nbsp;</td>
                  <td align="right"  >&nbsp;</td>
          ...
          <p>
              ...
              <span id="msg3" style="display:none;" class="bxEr" >Primero debe registrar el monto Total de mercadería compradas y luego los porcentajes </span>
