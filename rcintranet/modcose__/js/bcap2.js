...
$(document).ready( function() {    
    ...
    $("#addcertificacion").click( function( event ){                    
        ...
        $("#maxrow").val( nextrow );        
        $("#tablecertificacion > tbody").append("<tr id=\"row_"+nextrow+"\"><td align=\"center\"><input name=\"inputA_"+nextrow+"\" type=\"text\" id=\"inputA_"+nextrow+"\" size=\"30\" class=\"inpC2\" onKeyUp=\"this.value = this.value.toUpperCase();\" pattern=\"[A-Z ]*\" ></td> <td align=\"center\"><input name=\"inputB_"+nextrow+"\" style=\"text-align:right;\" type=\"text\" id=\"inputB_"+nextrow+"\" size=\"10\" maxlength=\"4\" class=\"integer validar inpC2\" ></td><td align=\"center\"><input name=\"inputC_"+nextrow+"\" type=\"text\" id=\"inputC_"+nextrow+"\" size=\"30\" class=\"inpC2\" onKeyUp=\"this.value = this.value.toUpperCase();\" pattern=\"[A-Z ]*\" ></td><td width=\"10%\" align=\"center\"><a href=\"#\" class=\"lnkCls\" id=\"delcerti_"+nextrow+"\" onclick=\"delRow("+nextrow+");return false;\" >eliminar</a></td></tr>");        
        numerico();
    });      
