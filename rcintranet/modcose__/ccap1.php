      ...
      $("#addcertificacion").click( function( event ){                    
        ...
        $("#tableaplications > tbody").append('<tr id="row_'+nextrow+'">'       
                            +'<td class="titR" >'
                                ...
                                +'</td>'
                                +'<td align="center">'
                                  +'<input name="napli_'+nextrow+'" type="text" id="napli_'+nextrow+'" size="30" value="" class="inpC2" /><span id="div_napli_'+nextrow+'" class="bxEr" style="display:none" >requerido</span></td>'
