...
<?php
//----------------------------------------------------------------
//--modificado por wilfredo mendoza - MDPYEP/VPIMGE - MARZO 2015 -
...
if ($_POST['gestion'] && OPERATOR::getDbValue("SELECT regi_gest_uid FROM sys_registros WHERE regi_uid=".$_SESSION[SITE]["registro_uid"])==0 ) {                                             
    ...
    if (OPERATOR::getDbValue("SELECT count(*) FROM sys_registros WHERE regi_user_uid=".$_SESSION[SITE]["usr_uid"]) > 1) {
        //Inicio de reserva de memoria en la base de datos, para el usuario registrado y la empresa activa.
...
//se obtiene toda la información de la empresa
...
<div class="content">           
    ...
    <form class="formA validable" action="acap1Add.php" method="post" autocomplete="off" >
        <fieldset>
            <p>
                ...
                <input type="text" name="ai_rs" id="ai_rs" disabled="disabled" value="<?php echo $aInfoGen["inge_razonsocial"] ?>"  size="50" class="inpC alphanum"  >                
                ...
                <span class="clear"></span>                            
                    ...
                    while ($aSocietario = $db->next_record()) {
                        ...
                        <?php if ($aInfoGen["inge_tiso_uid"] == $aSocietario["tiso_uid"]) {?>
                          <input type="text" name="ai_societario" id="ai_tiso"  disabled="disabled"  value="<?php echo $aSocietario["tiso_description"] ?>" size="50" class="inpC alphanum"   >                          
                        <?php    
                        }  } ?>                      
            </p>            
            <p>
                ...
                <span class="clear"></span>               
                <input type="text" name="ai_tradename"  disabled="disabled"  id="ai_tradename" value="<?php echo $aInfoGen["inge_nombrecomercial"] ?>" size="50" class="inpC alphanum"   >
                <span id="msg_ai_tradename"><?php echo OPERATOR::getDescTitles(1,'A',1,3); ?></span>
            </p>            
             <p>
                <span class="subT">CIIU:</span>
                <span class="clear"></span>             
                <input type="text" disabled="disabled" name="ai_ciiu" id="ai_ciiu"  value="<?php echo $aInfoGen["inge_ciiu"] ?>"  size="10" class="inpC alphanum">                
            </p>
            <p>
                <span class="subT">Clasificación según CIIU:</span>
                <!-- incorporado --->
                <span class="clear"></span>             
                <input type="text" disabled="disabled" name="ai_clase_ciiu" id="ai_clase_ciiu" value="<?php echo $aInfoGen["inge_clase_ciiu"] ?>"  size="70" class="inpC alphanum">                
            </p>            
            <p>
                <span class="subT">4. NIT:</span>
                <span class="clear"></span>                
                <input type="text" name="ai_nit" disabled="disabled" id="ai_nit" value="<?php echo $aInfoGen["inge_nit"] ?>" size="20"  maxlength="12" class="inpC alphanum">                
            </p>           
            <p>
                <span class="subT">5. N&uacute;mero de Matr&iacute;cula de Comercio:</span>
                <span class="clear"></span>                
                <input type="text" disabled="disabled" name="ai_traderegis" id="ai_traderegis" value="<?php echo $aInfoGen["inge_matriculadecomercio"] ?>" size="10" class="inpC integer" maxlength="8" >
            </p>                                         
            <p>
          ...
          <p>
                ...
                <span class="clear"></span>                                
                <input type="text" disabled="disabled" name="ai_depto" id="ai_depto" value="<?php echo $aInfoGen["inge_nombre_departamento"] ?>" size="40" class="inpC alphanum" maxlength="8" >                
            </p>
            <!--
            <p>
                ...
                <input type="text" disabled="disabled" name="ai_provin" id="ai_provin" value="<?php echo $aInfoGen["inge_nombre_provincia"] ?>" size="40" class="inpC alphanum" maxlength="8" >
                </span>                                
            </p>       
            -->
            <p>
                ...
                <input type="text" disabled="disabled" name="ai_municipio" id="ai_municipio" value="<?php echo $aInfoGen["inge_nombre_municipio"] ?>" size="40" class="inpC alphanum" maxlength="8" >     
              </span>                              
          </p>
          <p>
            <span class="subT">Ciudad:</span>
            <span class="clear"></span>                
            <input type="text" name="ai_city" disabled="disabled" id="ai_city" value="<?php echo $aInfoGen["inge_ciudad"] ?>" size="40" class="inpC alphanum" >            
          </p>
          <p>
        ...
        <table class="fOpt">
            <thead>
                <tr>
                    ...
                    -->
                    <th>Nombre de Calle o Avenida:</th>
                    <th>N&uacute;mero:</th>
                    <th>Zona/Barrio:</th>
                </tr>
            </thead>
            <tbody> 
              <tr>   <!--                     
                  ...
                  ?></td> -->
                  <td>  
                      <input type="text" disabled="disabled" name="ai_address" onblur="javascript:saveUPD(3); return false;" value="<?php echo $aInfoGen["inge_calle"] ?>" size="50" class="inpC" title="Registre el nombre de la calle, avenida, pasaje, etc. de ubicación de su empresa. En caso que se encuentre en carretera o camino, señale el nombre de la carretera o camino y el kilómetro de ubicación. Por ejemplo: carretera a Cotoca, km 8." id="ai_address">
                  </td>
                  <td>
                      <input type="text" disabled="disabled" name="ai_numerocalle" id="ai_numerocalle" onblur="javascript:saveUPD(3); return false;" value="<?php echo $aInfoGen["inge_numcalle"] ?>" size="10" class="inpC" title="Registre el número de dirección de su empresa. En caso que no tenga número anote SN. "  /> 
                  </td>
                  <td>
                    <input type="text" name="ai_zona" placeholder="SOPOCACHI" disabled="disabled" id="ai_zona" onblur="javascript:saveUPD(3); return false;" value="<?php echo $aInfoGen["inge_zona"] ?>" size="40" class="inpC" title="Registre el nombre de la zona o barrio de ubicación de su empresa." />                    
                </td>
            </tr>
        </tbody>
    </table>
    <p>
        <span class="subT">Referencia (Entre qué calles)<span class="color4"></span>:</span>
        <span class="clear"></span>               
        <textarea name="ai_reference" placeholder="ENTRE CALLE ROSENDO GUTIERREZ Y BELISARIO SALINAS" cols="60" rows="3" style="height:80px;" onblur="javascript:saveUPD(3); return false;" class="inpC" onKeyUp="this.value = this.value.toUpperCase();" title="Registre algún tipo de referencia que facilite la ubicación de su empresa. Por ejemplo: esquina calle Sucre;  entre calles 1 y 2; frente al monumento a Sim&oacute;n Bol&iacute;var; detrás del surtidor de gasolina." id="ai_reference"><?php echo $aInfoGen["inge_referenciacalle"] ?></textarea>
    ...
    <p>
        ...
        <span class="clear"></span>                  
        <input type="text" maxlength="7" name="ai_phone1" id="ai_phone1"  disabled="disabled" value="<?php echo $aInfoGen["inge_telefono"] ?>" size="40" class="inpC">
    ...
    <p>
        ...
        <span class="clear"></span>                 
        <input type="text" name="ai_phone2" maxlength="8" id="ai_phone2"  disabled="disabled"  value="<?php echo $aInfoGen["inge_celular"] ?>" size="40" class="inpC">
       
    </p>    
    <p>
        <span class="subT">9. Fax:</span>
        <span class="clear"></span>                  
        <input type="text"  disabled="disabled"  name="ai_fax" id="ai_fax"  value="<?php echo $aInfoGen["inge_fax"] ?>" size="40" class="inpC">        
    </p>
    <p>
        <span class="subT">10. P&aacute;gina Web:</span>
        <span class="clear"></span>                  
        <input type="text"  disabled="disabled" name="ai_pagweb" id="ai_pagweb"  value="<?php echo $aInfoGen["inge_pagweb"] ?>" size="40" class="inpC" >
        <span id="div_ai_pagweb_2" class="bxEr" style="display:none" >inválido</span>
    </p>
    <p>
        <span class="subT">11. Correo electr&oacute;nico:</span>
        <span class="clear"></span>                 
        <input type="text" name="ai_email" id="ai_email" disabled="disabled" value="<?php echo $aInfoGen["inge_email"] ?>" size="40" class="inpC ">                
    </p>     

    <p>        
        <span class="subT">12. Afiliaci&oacute;n de la empresa<span class="color4">*</span>:</span>
        <!----->
     <p class="left" style="margin-right:200px;">Debe seleccionar al menos una de las opciones.</p><br> 
     <p>
        ...
        <input type="text" class="inpC" size="40"  name="afil_camara" onKeyUp="this.value = this.value.toUpperCase();"  pattern="[A-Z ]*" id="afil_camara" onblur="javascript:saveUPD(4); return false;" value="<?php echo $aInfoGen["inge_afiliacion_camara"] ?>" size="40" <?php echo $show1;  ?>   />
        <span class="clear"></span>
        ...
        <input type="text" class="inpC" size="40" name="afil_federacion" onKeyUp="this.value = this.value.toUpperCase();" pattern="[A-Z ]*" id="afil_federacion" onblur="javascript:saveUPD(4); return false;" value="<?php echo $aInfoGen["inge_afiliacion_federacion"] ?>" size="40" <?php echo $show2;  ?>  />
        <span class="clear"></span>
        ...
        <input type="text" class="inpC" size="40" name="afil_asociacion"  onKeyUp="this.value = this.value.toUpperCase();" pattern="[A-Z ]*" onblur="javascript:saveUPD(4); return false;" id="afil_asociacion" value="<?php echo $aInfoGen["inge_afiliacion_asociacion"] ?>" size="40" <?php echo $show2;  ?>  />
        <span class="clear"></span>
        ...
        <input type="text" class="inpC" size="40" name="afil_otros"  onKeyUp="this.value = this.value.toUpperCase();"  pattern="[A-Z ]*" id="afil_otros" onblur="javascript:saveUPD(4); return false;" value="<?php echo $aInfoGen["inge_afiliacion_otros"] ?>" size="40" <?php echo $show3;  ?>  ><br>
        <span id="div_afil_otros" style="display:none" class="bxEr">requerido</span>
        <span class="clear"></span>
    ...
    <p>
        ...
        <br>En caso de no tener actividades decundarias escribir <b>NINGUNA</b>
    </p>
    <p>
        <span class="subT">a) Actividad Principal:</span>
        <span class="clear"></span>                
        <input type="text" name="ai_actprin" id="ai_actprin" disabled="disabled" value="<?php echo $aInfoGen["inge_actividad_principal"] ?>" size="80" class="inpC">        
    </p>
    <p>
        <span class="subT">b) Actividad Secundaria 1:</span>
        <span class="clear"></span>                  
        <input type="text" name="ai_actsec1"  id="ai_actsec1" value="<?php echo $aInfoGen["inge_actividad_secundaria1"] ?>" size="80" class="inpC alphanum" onKeyUp="this.value = this.value.toUpperCase();" pattern="[A-Z ]*"> 
    ...
    <p>
        ...
        <span class="clear"></span>
        <input type="text" name="ai_actsec2" id="ai_actsec2" value="<?php echo $aInfoGen["inge_actividad_secundaria2"] ?>" size="80" class="inpC alphanum" onKeyUp="this.value = this.value.toUpperCase();"  pattern="[A-Z ]*">
